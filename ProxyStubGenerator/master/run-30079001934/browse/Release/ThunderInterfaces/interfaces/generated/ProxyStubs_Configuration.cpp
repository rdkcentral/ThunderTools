...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConfigurationStubMethods[] = {
        // (0) virtual uint32_t Configure(PluginHost::IShell*) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                if (RPC::Administrator::Instance().IsValid(channel, RPC::instance_cast(implementation), Exchange::IConfiguration::ID) == false) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
            ...
            if (hresult != Core::ERROR_NONE) {
                fprintf(stderr, "COM-RPC stub 0x%08x(%u) failed: 0x%08x\n", Exchange::IConfiguration::ID, 0, hresult);
    ...
    namespace {
        ...
        public:
            Instantiation()
            {
                ...
                RPC::Administrator::Instance().Announce<Exchange::IConfiguration, ExchangeConfigurationProxy, ExchangeConfigurationStub>(security);
            }
            ~Instantiation()
            {
