...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_e40ac210InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_e40ac210{};
                ProxyStub::UnknownProxy* _parameter_e40ac210Proxy__ = nullptr;
                if (_parameter_e40ac210InstanceId__ != 0) {
                    _parameter_e40ac210Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_e40ac210InstanceId__, false, _parameter_e40ac210);
                    ASSERT((_parameter_e40ac210 != nullptr) && (_parameter_e40ac210Proxy__ != nullptr));
                    if ((_parameter_e40ac210 == nullptr) || (_parameter_e40ac210Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Initialize(_parameter_e40ac210);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_e40ac210Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_e40ac210Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_04e0c7d2InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_04e0c7d2{};
                ProxyStub::UnknownProxy* _parameter_04e0c7d2Proxy__ = nullptr;
                if (_parameter_04e0c7d2InstanceId__ != 0) {
                    _parameter_04e0c7d2Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_04e0c7d2InstanceId__, false, _parameter_04e0c7d2);
                    ASSERT((_parameter_04e0c7d2 != nullptr) && (_parameter_04e0c7d2Proxy__ != nullptr));
                    if ((_parameter_04e0c7d2 == nullptr) || (_parameter_04e0c7d2Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deinitialize(_parameter_04e0c7d2);

                if (_parameter_04e0c7d2Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_04e0c7d2Proxy__, message->Response());
                }
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_9674cb65InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_9674cb65{};
                ProxyStub::UnknownProxy* _parameter_9674cb65Proxy__ = nullptr;
                if (_parameter_9674cb65InstanceId__ != 0) {
                    _parameter_9674cb65Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_9674cb65InstanceId__, false, _parameter_9674cb65);
                    ASSERT((_parameter_9674cb65 != nullptr) && (_parameter_9674cb65Proxy__ != nullptr));
                    if ((_parameter_9674cb65 == nullptr) || (_parameter_9674cb65Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Configure(_parameter_9674cb65);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_9674cb65Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_9674cb65Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_e40ac210) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_e40ac210));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_e40ac210), PluginHost::IShell::ID }, { 0, 0 } };
        ...
        void Deinitialize(PluginHost::IShell* _parameter_04e0c7d2) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_04e0c7d2));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_04e0c7d2), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_9674cb65) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_9674cb65));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_9674cb65), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
