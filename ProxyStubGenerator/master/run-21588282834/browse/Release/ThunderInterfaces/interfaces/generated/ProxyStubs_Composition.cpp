...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeCompositionStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                const Exchange::IComposition::ScreenResolution _parameter_c7edf397 = reader.Number<Exchange::IComposition::ScreenResolution>();

                uint32_t result = implementation->Resolution(_parameter_c7edf397);
    ...
    static ProxyStub::MethodHandler ExchangeCompositionDisplayStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (Core::RealSize<Exchange::IComposition::ScreenResolution>())) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                const Exchange::IComposition::ScreenResolution _parameter_dcb2a032 = reader.Number<Exchange::IComposition::ScreenResolution>();

                uint32_t result = implementation->Resolution(_parameter_dcb2a032);
    ...
    public:
        ...
        uint32_t Resolution(const Exchange::IComposition::ScreenResolution _parameter_c7edf397) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(3));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Exchange::IComposition::ScreenResolution>(_parameter_c7edf397);
    ...
    public:
        ...
        uint32_t Resolution(const Exchange::IComposition::ScreenResolution _parameter_dcb2a032) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(3));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Exchange::IComposition::ScreenResolution>(_parameter_dcb2a032);
