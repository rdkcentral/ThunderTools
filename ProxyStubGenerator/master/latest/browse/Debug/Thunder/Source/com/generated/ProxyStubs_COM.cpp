...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_5c3cb1baInstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_5c3cb1ba{};
            ProxyStub::UnknownProxy* _parameter_5c3cb1baProxy__ = nullptr;
            if (_parameter_5c3cb1baInstanceId__ != 0) {
                _parameter_5c3cb1baProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_5c3cb1baInstanceId__, false, _parameter_5c3cb1ba);
                ASSERT((_parameter_5c3cb1ba != nullptr) && (_parameter_5c3cb1baProxy__ != nullptr));
            }

            implementation->Activated(_parameter_5c3cb1ba);

            if (_parameter_5c3cb1baProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_5c3cb1baProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_a3144637InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_a3144637{};
            ProxyStub::UnknownProxy* _parameter_a3144637Proxy__ = nullptr;
            if (_parameter_a3144637InstanceId__ != 0) {
                _parameter_a3144637Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_a3144637InstanceId__, false, _parameter_a3144637);
                ASSERT((_parameter_a3144637 != nullptr) && (_parameter_a3144637Proxy__ != nullptr));
            }

            implementation->Deactivated(_parameter_a3144637);

            if (_parameter_a3144637Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_a3144637Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_f612c9cdInstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_f612c9cd{};
            ProxyStub::UnknownProxy* _parameter_f612c9cdProxy__ = nullptr;
            if (_parameter_f612c9cdInstanceId__ != 0) {
                _parameter_f612c9cdProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_f612c9cdInstanceId__, false, _parameter_f612c9cd);
                ASSERT((_parameter_f612c9cd != nullptr) && (_parameter_f612c9cdProxy__ != nullptr));
            }

            implementation->Terminated(_parameter_f612c9cd);

            if (_parameter_f612c9cdProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_f612c9cdProxy__, message->Response());
            }
        }
        , nullptr
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_5c3cb1ba) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_5c3cb1ba));
        ...
        void Deactivated(IRemoteConnection* _parameter_a3144637) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_a3144637));
        ...
        void Terminated(IRemoteConnection* _parameter_f612c9cd) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_f612c9cd));
