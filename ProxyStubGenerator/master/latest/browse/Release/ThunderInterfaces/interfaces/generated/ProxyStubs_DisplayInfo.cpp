...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_1b7f7ad9InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_1b7f7ad9{};
                ProxyStub::UnknownProxy* _parameter_1b7f7ad9Proxy__ = nullptr;
                if (_parameter_1b7f7ad9InstanceId__ != 0) {
                    _parameter_1b7f7ad9Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_1b7f7ad9InstanceId__, false, _parameter_1b7f7ad9);
                    ASSERT((_parameter_1b7f7ad9 != nullptr) && (_parameter_1b7f7ad9Proxy__ != nullptr));
                    if ((_parameter_1b7f7ad9 == nullptr) || (_parameter_1b7f7ad9Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_1b7f7ad9);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_1b7f7ad9Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_1b7f7ad9Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_7257f935InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_7257f935{};
                ProxyStub::UnknownProxy* _parameter_7257f935Proxy__ = nullptr;
                if (_parameter_7257f935InstanceId__ != 0) {
                    _parameter_7257f935Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_7257f935InstanceId__, false, _parameter_7257f935);
                    ASSERT((_parameter_7257f935 != nullptr) && (_parameter_7257f935Proxy__ != nullptr));
                    if ((_parameter_7257f935 == nullptr) || (_parameter_7257f935Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_7257f935);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_7257f935Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_7257f935Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_1b7f7ad9) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_1b7f7ad9));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_1b7f7ad9), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_7257f935) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_7257f935));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_7257f935), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
