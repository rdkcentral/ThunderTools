...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstance9E4C5FD5 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance9E4C5FD5StubMethods[] = {
        // (0) virtual bool Next(string&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstance9E4C5FD5StubMethods

    //
    // RPC::IIteratorTypeInstance6E234328 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance6E234328StubMethods[] = {
        // (0) virtual bool Next(Exchange::IStoreInspector::NamespaceSize&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstance6E234328StubMethods
    ...
    //
    // RPC::IIteratorTypeInstance9E4C5FD5 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(string&) = 0
    //  (1) virtual bool Previous(string&) = 0
    ...
    class RPCIteratorTypeInstance9E4C5FD5Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>> {
    public:
        RPCIteratorTypeInstance9E4C5FD5Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstance9E4C5FD5Proxy

    //
    // RPC::IIteratorTypeInstance6E234328 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IStoreInspector::NamespaceSize&) = 0
    //  (1) virtual bool Previous(Exchange::IStoreInspector::NamespaceSize&) = 0
    ...
    class RPCIteratorTypeInstance6E234328Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IStoreInspector::NamespaceSize, Exchange::ID_STORE_INSPECTOR_NAMESPACE_SIZE_ITERATOR>> {
    public:
        RPCIteratorTypeInstance6E234328Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstance6E234328Proxy
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstance9E4C5FD5StubMethods> RPCIteratorTypeInstance9E4C5FD5Stub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IStoreInspector::NamespaceSize, Exchange::ID_STORE_INSPECTOR_NAMESPACE_SIZE_ITERATOR>, RPCIteratorTypeInstance6E234328StubMethods> RPCIteratorTypeInstance6E234328Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstance9E4C5FD5Proxy, RPCIteratorTypeInstance9E4C5FD5Stub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IStoreInspector::NamespaceSize, Exchange::ID_STORE_INSPECTOR_NAMESPACE_SIZE_ITERATOR>, RPCIteratorTypeInstance6E234328Proxy, RPCIteratorTypeInstance6E234328Stub>();
