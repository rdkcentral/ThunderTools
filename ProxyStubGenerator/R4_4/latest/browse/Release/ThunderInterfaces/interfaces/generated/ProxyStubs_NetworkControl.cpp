...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstance95EF3929 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance95EF3929StubMethods[] = {
        // (0) virtual bool Next(Exchange::INetworkControl::NetworkInfo&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstance95EF3929StubMethods

    //
    // RPC::IIteratorTypeInstance8DE6830E interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance8DE6830EStubMethods[] = {
        // (0) virtual bool Next(string&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstance8DE6830EStubMethods
    ...
    //
    // RPC::IIteratorTypeInstance95EF3929 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::INetworkControl::NetworkInfo&) = 0
    //  (1) virtual bool Previous(Exchange::INetworkControl::NetworkInfo&) = 0
    ...
    class RPCIteratorTypeInstance95EF3929Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::INetworkControl::NetworkInfo, Exchange::ID_NETWORKCONTROL_NETWORK_INFO_ITERATOR>> {
    public:
        RPCIteratorTypeInstance95EF3929Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstance95EF3929Proxy

    //
    // RPC::IIteratorTypeInstance8DE6830E interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(string&) = 0
    //  (1) virtual bool Previous(string&) = 0
    ...
    class RPCIteratorTypeInstance8DE6830EProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>> {
    public:
        RPCIteratorTypeInstance8DE6830EProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstance8DE6830EProxy
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::INetworkControl::NetworkInfo, Exchange::ID_NETWORKCONTROL_NETWORK_INFO_ITERATOR>, RPCIteratorTypeInstance95EF3929StubMethods> RPCIteratorTypeInstance95EF3929Stub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstance8DE6830EStubMethods> RPCIteratorTypeInstance8DE6830EStub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::INetworkControl::NetworkInfo, Exchange::ID_NETWORKCONTROL_NETWORK_INFO_ITERATOR>, RPCIteratorTypeInstance95EF3929Proxy, RPCIteratorTypeInstance95EF3929Stub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstance8DE6830EProxy, RPCIteratorTypeInstance8DE6830EStub>();
