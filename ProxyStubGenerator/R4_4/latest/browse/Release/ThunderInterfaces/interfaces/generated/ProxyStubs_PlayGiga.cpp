...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_842eae61 = reader.Text();
            const string _parameter_e41e5493 = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_842eae61), static_cast<const string&>(_parameter_e41e5493));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_842eae61, const string& _parameter_e41e5493) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(static_cast<const string&>(_parameter_842eae61));
            writer.Text(static_cast<const string&>(_parameter_e41e5493));
