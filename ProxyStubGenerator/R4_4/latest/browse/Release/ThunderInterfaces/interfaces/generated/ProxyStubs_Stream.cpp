...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const Core::instance_id parameter_51ccf924Implementation = reader.Number<Core::instance_id>();

            Exchange::IStream::ICallback* _parameter_51ccf924 = nullptr;
            ProxyStub::UnknownProxy* parameter_51ccf924Proxy = nullptr;
            if (parameter_51ccf924Implementation != 0) {
                parameter_51ccf924Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_51ccf924Implementation, false, _parameter_51ccf924);

                ASSERT((_parameter_51ccf924 != nullptr) && (parameter_51ccf924Proxy != nullptr));
            }

            implementation->Callback(_parameter_51ccf924);

            if (parameter_51ccf924Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_51ccf924Proxy, message->Response());
            }
        },
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_51ccf924) override
        {
            IPCMessage message(BaseClass::Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_51ccf924));
