...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstance26E7D197 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance26E7D197StubMethods[] = {
        // (0) virtual bool Next(Exchange::IWifiControl::SecurityInfo&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstance26E7D197StubMethods

    //
    // RPC::IIteratorTypeInstance5E1C2D22 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance5E1C2D22StubMethods[] = {
        // (0) virtual bool Next(Exchange::IWifiControl::NetworkInfo&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstance5E1C2D22StubMethods

    //
    // RPC::IIteratorTypeInstance7E17053D interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance7E17053DStubMethods[] = {
        // (0) virtual bool Next(string&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstance7E17053DStubMethods
    ...
    //
    // RPC::IIteratorTypeInstance26E7D197 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IWifiControl::SecurityInfo&) = 0
    //  (1) virtual bool Previous(Exchange::IWifiControl::SecurityInfo&) = 0
    ...
    class RPCIteratorTypeInstance26E7D197Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IWifiControl::SecurityInfo, Exchange::ID_WIFICONTROL_SECURITY_INFO_ITERATOR>> {
    public:
        RPCIteratorTypeInstance26E7D197Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstance26E7D197Proxy

    //
    // RPC::IIteratorTypeInstance5E1C2D22 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IWifiControl::NetworkInfo&) = 0
    //  (1) virtual bool Previous(Exchange::IWifiControl::NetworkInfo&) = 0
    ...
    class RPCIteratorTypeInstance5E1C2D22Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IWifiControl::NetworkInfo, Exchange::ID_WIFICONTROL_NETWORK_INFO_ITERATOR>> {
    public:
        RPCIteratorTypeInstance5E1C2D22Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstance5E1C2D22Proxy

    //
    // RPC::IIteratorTypeInstance7E17053D interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(string&) = 0
    //  (1) virtual bool Previous(string&) = 0
    ...
    class RPCIteratorTypeInstance7E17053DProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>> {
    public:
        RPCIteratorTypeInstance7E17053DProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstance7E17053DProxy
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IWifiControl::SecurityInfo, Exchange::ID_WIFICONTROL_SECURITY_INFO_ITERATOR>, RPCIteratorTypeInstance26E7D197StubMethods> RPCIteratorTypeInstance26E7D197Stub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IWifiControl::NetworkInfo, Exchange::ID_WIFICONTROL_NETWORK_INFO_ITERATOR>, RPCIteratorTypeInstance5E1C2D22StubMethods> RPCIteratorTypeInstance5E1C2D22Stub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstance7E17053DStubMethods> RPCIteratorTypeInstance7E17053DStub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IWifiControl::SecurityInfo, Exchange::ID_WIFICONTROL_SECURITY_INFO_ITERATOR>, RPCIteratorTypeInstance26E7D197Proxy, RPCIteratorTypeInstance26E7D197Stub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IWifiControl::NetworkInfo, Exchange::ID_WIFICONTROL_NETWORK_INFO_ITERATOR>, RPCIteratorTypeInstance5E1C2D22Proxy, RPCIteratorTypeInstance5E1C2D22Stub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstance7E17053DProxy, RPCIteratorTypeInstance7E17053DStub>();
