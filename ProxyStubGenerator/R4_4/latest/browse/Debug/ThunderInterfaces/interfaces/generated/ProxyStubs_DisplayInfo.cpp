...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstanceBB438997 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceBB438997StubMethods[] = {
        // (0) virtual bool Next(Exchange::IHDRProperties::HDRType&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceBB438997StubMethods

    //
    // RPC::IIteratorTypeInstance26D69E36 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance26D69E36StubMethods[] = {
        // (0) virtual bool Next(Exchange::IDisplayProperties::ColorimetryType&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstance26D69E36StubMethods
    ...
    ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_bfc36108Implementation = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_bfc36108 = nullptr;
            ProxyStub::UnknownProxy* parameter_bfc36108Proxy = nullptr;
            if (parameter_bfc36108Implementation != 0) {
                parameter_bfc36108Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_bfc36108Implementation, false, _parameter_bfc36108);

                ASSERT((_parameter_bfc36108 != nullptr) && (parameter_bfc36108Proxy != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_bfc36108);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_bfc36108Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_bfc36108Proxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_db44cf4aImplementation = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_db44cf4a = nullptr;
            ProxyStub::UnknownProxy* parameter_db44cf4aProxy = nullptr;
            if (parameter_db44cf4aImplementation != 0) {
                parameter_db44cf4aProxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_db44cf4aImplementation, false, _parameter_db44cf4a);

                ASSERT((_parameter_db44cf4a != nullptr) && (parameter_db44cf4aProxy != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_db44cf4a);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_db44cf4aProxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_db44cf4aProxy, message->Response());
            }
        },
    ...
    //
    // RPC::IIteratorTypeInstanceBB438997 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IHDRProperties::HDRType&) = 0
    //  (1) virtual bool Previous(Exchange::IHDRProperties::HDRType&) = 0
    ...
    class RPCIteratorTypeInstanceBB438997Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>> {
    public:
        RPCIteratorTypeInstanceBB438997Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstanceBB438997Proxy

    //
    // RPC::IIteratorTypeInstance26D69E36 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IDisplayProperties::ColorimetryType&) = 0
    //  (1) virtual bool Previous(Exchange::IDisplayProperties::ColorimetryType&) = 0
    ...
    class RPCIteratorTypeInstance26D69E36Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>> {
    public:
        RPCIteratorTypeInstance26D69E36Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstance26D69E36Proxy
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_bfc36108) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_bfc36108));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_db44cf4a) override
        {
            IPCMessage message(BaseClass::Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_db44cf4a));
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>, RPCIteratorTypeInstanceBB438997StubMethods> RPCIteratorTypeInstanceBB438997Stub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>, RPCIteratorTypeInstance26D69E36StubMethods> RPCIteratorTypeInstance26D69E36Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>, RPCIteratorTypeInstanceBB438997Proxy, RPCIteratorTypeInstanceBB438997Stub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>, RPCIteratorTypeInstance26D69E36Proxy, RPCIteratorTypeInstance26D69E36Stub>();
