...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler CompositPluginStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_6d4ec8d6Implementation = reader.Number<Core::instance_id>();

            ICompositPlugin::INotification* _parameter_6d4ec8d6 = nullptr;
            ProxyStub::UnknownProxy* parameter_6d4ec8d6Proxy = nullptr;
            if (parameter_6d4ec8d6Implementation != 0) {
                parameter_6d4ec8d6Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_6d4ec8d6Implementation, false, _parameter_6d4ec8d6);

                ASSERT((_parameter_6d4ec8d6 != nullptr) && (parameter_6d4ec8d6Proxy != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_6d4ec8d6);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_6d4ec8d6Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_6d4ec8d6Proxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_3844e25fImplementation = reader.Number<Core::instance_id>();

            ICompositPlugin::INotification* _parameter_3844e25f = nullptr;
            ProxyStub::UnknownProxy* parameter_3844e25fProxy = nullptr;
            if (parameter_3844e25fImplementation != 0) {
                parameter_3844e25fProxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_3844e25fImplementation, false, _parameter_3844e25f);

                ASSERT((_parameter_3844e25f != nullptr) && (parameter_3844e25fProxy != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_3844e25f);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_3844e25fProxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_3844e25fProxy, message->Response());
            }
        }
        , nullptr
    ...
    public:
        ...
        uint32_t Register(ICompositPlugin::INotification* _parameter_6d4ec8d6) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_6d4ec8d6));
        ...
        uint32_t Unregister(ICompositPlugin::INotification* _parameter_3844e25f) override
        {
            IPCMessage message(BaseClass::Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_3844e25f));
