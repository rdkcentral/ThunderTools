...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler CompositPluginStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_f6d523aaImplementation = reader.Number<Core::instance_id>();

            ICompositPlugin::INotification* _parameter_f6d523aa = nullptr;
            ProxyStub::UnknownProxy* parameter_f6d523aaProxy = nullptr;
            if (parameter_f6d523aaImplementation != 0) {
                parameter_f6d523aaProxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_f6d523aaImplementation, false, _parameter_f6d523aa);

                ASSERT((_parameter_f6d523aa != nullptr) && (parameter_f6d523aaProxy != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_f6d523aa);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_f6d523aaProxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_f6d523aaProxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_5e4d85c4Implementation = reader.Number<Core::instance_id>();

            ICompositPlugin::INotification* _parameter_5e4d85c4 = nullptr;
            ProxyStub::UnknownProxy* parameter_5e4d85c4Proxy = nullptr;
            if (parameter_5e4d85c4Implementation != 0) {
                parameter_5e4d85c4Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_5e4d85c4Implementation, false, _parameter_5e4d85c4);

                ASSERT((_parameter_5e4d85c4 != nullptr) && (parameter_5e4d85c4Proxy != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_5e4d85c4);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_5e4d85c4Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_5e4d85c4Proxy, message->Response());
            }
        }
        , nullptr
    ...
    public:
        ...
        uint32_t Register(ICompositPlugin::INotification* _parameter_f6d523aa) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_f6d523aa));
        ...
        uint32_t Unregister(ICompositPlugin::INotification* _parameter_5e4d85c4) override
        {
            IPCMessage message(BaseClass::Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_5e4d85c4));
