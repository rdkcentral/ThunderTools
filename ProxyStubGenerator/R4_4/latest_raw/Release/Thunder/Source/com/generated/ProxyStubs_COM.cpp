...
namespace ProxyStubs {
    ...
    //
    // IIteratorTypeInstance98906046 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler IteratorTypeInstance98906046StubMethods[] = {
        // (0) virtual bool Next(string&) = 0
        //
        ...
        , nullptr
    }; // IteratorTypeInstance98906046StubMethods

    //
    // IIteratorTypeInstanceE9B21912 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler IteratorTypeInstanceE9B21912StubMethods[] = {
        // (0) virtual bool Next(uint32_t&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // IteratorTypeInstanceE9B21912StubMethods
    ...
    ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_fbb7beabImplementation = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_fbb7beab = nullptr;
            ProxyStub::UnknownProxy* parameter_fbb7beabProxy = nullptr;
            if (parameter_fbb7beabImplementation != 0) {
                parameter_fbb7beabProxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_fbb7beabImplementation, false, _parameter_fbb7beab);

                ASSERT((_parameter_fbb7beab != nullptr) && (parameter_fbb7beabProxy != nullptr));
            }

            implementation->Activated(_parameter_fbb7beab);

            if (parameter_fbb7beabProxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_fbb7beabProxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_b2561116Implementation = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_b2561116 = nullptr;
            ProxyStub::UnknownProxy* parameter_b2561116Proxy = nullptr;
            if (parameter_b2561116Implementation != 0) {
                parameter_b2561116Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_b2561116Implementation, false, _parameter_b2561116);

                ASSERT((_parameter_b2561116 != nullptr) && (parameter_b2561116Proxy != nullptr));
            }

            implementation->Deactivated(_parameter_b2561116);

            if (parameter_b2561116Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_b2561116Proxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_57ab9541Implementation = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_57ab9541 = nullptr;
            ProxyStub::UnknownProxy* parameter_57ab9541Proxy = nullptr;
            if (parameter_57ab9541Implementation != 0) {
                parameter_57ab9541Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_57ab9541Implementation, false, _parameter_57ab9541);

                ASSERT((_parameter_57ab9541 != nullptr) && (parameter_57ab9541Proxy != nullptr));
            }

            implementation->Terminated(_parameter_57ab9541);

            if (parameter_57ab9541Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_57ab9541Proxy, message->Response());
            }
        }
        , nullptr
    ...
    //
    // IIteratorTypeInstance98906046 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(string&) = 0
    //  (1) virtual bool Previous(string&) = 0
    ...
    class IteratorTypeInstance98906046Proxy final : public ProxyStub::UnknownProxyType<IIteratorType<string, ID_STRINGITERATOR>> {
    public:
        IteratorTypeInstance98906046Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class IteratorTypeInstance98906046Proxy

    //
    // IIteratorTypeInstanceE9B21912 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(uint32_t&) = 0
    //  (1) virtual bool Previous(uint32_t&) = 0
    ...
    class IteratorTypeInstanceE9B21912Proxy final : public ProxyStub::UnknownProxyType<IIteratorType<uint32_t, ID_VALUEITERATOR>> {
    public:
        IteratorTypeInstanceE9B21912Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class IteratorTypeInstanceE9B21912Proxy
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_fbb7beab) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_fbb7beab));
        ...
        void Deactivated(IRemoteConnection* _parameter_b2561116) override
        {
            IPCMessage message(BaseClass::Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_b2561116));
        ...
        void Terminated(IRemoteConnection* _parameter_57ab9541) override
        {
            IPCMessage message(BaseClass::Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_57ab9541));
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<IIteratorType<string, ID_STRINGITERATOR>, IteratorTypeInstance98906046StubMethods> IteratorTypeInstance98906046Stub;
        typedef ProxyStub::UnknownStubType<IIteratorType<uint32_t, ID_VALUEITERATOR>, IteratorTypeInstanceE9B21912StubMethods> IteratorTypeInstanceE9B21912Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<IIteratorType<string, ID_STRINGITERATOR>, IteratorTypeInstance98906046Proxy, IteratorTypeInstance98906046Stub>();
                RPC::Administrator::Instance().Announce<IIteratorType<uint32_t, ID_VALUEITERATOR>, IteratorTypeInstanceE9B21912Proxy, IteratorTypeInstanceE9B21912Stub>();
