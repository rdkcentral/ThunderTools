...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstanceAF65B87B interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceAF65B87BStubMethods[] = {
        // (0) virtual bool Next(Exchange::INetworkControl::NetworkInfo&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceAF65B87BStubMethods

    //
    // RPC::IIteratorTypeInstance36839EDD interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance36839EDDStubMethods[] = {
        // (0) virtual bool Next(string&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstance36839EDDStubMethods
    ...
    //
    // RPC::IIteratorTypeInstanceAF65B87B interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::INetworkControl::NetworkInfo&) = 0
    //  (1) virtual bool Previous(Exchange::INetworkControl::NetworkInfo&) = 0
    ...
    class RPCIteratorTypeInstanceAF65B87BProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::INetworkControl::NetworkInfo, Exchange::ID_NETWORKCONTROL_NETWORK_INFO_ITERATOR>> {
    public:
        RPCIteratorTypeInstanceAF65B87BProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstanceAF65B87BProxy

    //
    // RPC::IIteratorTypeInstance36839EDD interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(string&) = 0
    //  (1) virtual bool Previous(string&) = 0
    ...
    class RPCIteratorTypeInstance36839EDDProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>> {
    public:
        RPCIteratorTypeInstance36839EDDProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstance36839EDDProxy
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::INetworkControl::NetworkInfo, Exchange::ID_NETWORKCONTROL_NETWORK_INFO_ITERATOR>, RPCIteratorTypeInstanceAF65B87BStubMethods> RPCIteratorTypeInstanceAF65B87BStub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstance36839EDDStubMethods> RPCIteratorTypeInstance36839EDDStub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::INetworkControl::NetworkInfo, Exchange::ID_NETWORKCONTROL_NETWORK_INFO_ITERATOR>, RPCIteratorTypeInstanceAF65B87BProxy, RPCIteratorTypeInstanceAF65B87BStub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstance36839EDDProxy, RPCIteratorTypeInstance36839EDDStub>();
