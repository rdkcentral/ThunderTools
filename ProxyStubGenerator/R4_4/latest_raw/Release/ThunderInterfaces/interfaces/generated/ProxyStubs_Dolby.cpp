...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const Core::instance_id parameter_49351034Implementation = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_49351034 = nullptr;
            ProxyStub::UnknownProxy* parameter_49351034Proxy = nullptr;
            if (parameter_49351034Implementation != 0) {
                parameter_49351034Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_49351034Implementation, false, _parameter_49351034);

                ASSERT((_parameter_49351034 != nullptr) && (parameter_49351034Proxy != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_49351034);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_49351034Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_49351034Proxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_c84852b3Implementation = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_c84852b3 = nullptr;
            ProxyStub::UnknownProxy* parameter_c84852b3Proxy = nullptr;
            if (parameter_c84852b3Implementation != 0) {
                parameter_c84852b3Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_c84852b3Implementation, false, _parameter_c84852b3);

                ASSERT((_parameter_c84852b3 != nullptr) && (parameter_c84852b3Proxy != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_c84852b3);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_c84852b3Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_c84852b3Proxy, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_49351034) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_49351034));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_c84852b3) override
        {
            IPCMessage message(BaseClass::Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_c84852b3));
