...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstance4DC148F9 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance4DC148F9StubMethods[] = {
        // (0) virtual bool Next(Exchange::IBluetoothAudioSink::audiocodec&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstance4DC148F9StubMethods

    //
    // RPC::IIteratorTypeInstanceF1CB1513 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceF1CB1513StubMethods[] = {
        // (0) virtual bool Next(Exchange::IBluetoothAudioSink::drmscheme&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceF1CB1513StubMethods
    ...
    //
    // RPC::IIteratorTypeInstance4DC148F9 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IBluetoothAudioSink::audiocodec&) = 0
    //  (1) virtual bool Previous(Exchange::IBluetoothAudioSink::audiocodec&) = 0
    ...
    class RPCIteratorTypeInstance4DC148F9Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IBluetoothAudioSink::audiocodec, Exchange::ID_BLUETOOTHAUDIOSINK_AUDIOCODECITERATOR>> {
    public:
        RPCIteratorTypeInstance4DC148F9Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstance4DC148F9Proxy

    //
    // RPC::IIteratorTypeInstanceF1CB1513 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IBluetoothAudioSink::drmscheme&) = 0
    //  (1) virtual bool Previous(Exchange::IBluetoothAudioSink::drmscheme&) = 0
    ...
    class RPCIteratorTypeInstanceF1CB1513Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IBluetoothAudioSink::drmscheme, Exchange::ID_BLUETOOTHAUDIOSINK_DRMSCHEMEITERATOR>> {
    public:
        RPCIteratorTypeInstanceF1CB1513Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstanceF1CB1513Proxy
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IBluetoothAudioSink::audiocodec, Exchange::ID_BLUETOOTHAUDIOSINK_AUDIOCODECITERATOR>, RPCIteratorTypeInstance4DC148F9StubMethods> RPCIteratorTypeInstance4DC148F9Stub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IBluetoothAudioSink::drmscheme, Exchange::ID_BLUETOOTHAUDIOSINK_DRMSCHEMEITERATOR>, RPCIteratorTypeInstanceF1CB1513StubMethods> RPCIteratorTypeInstanceF1CB1513Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IBluetoothAudioSink::audiocodec, Exchange::ID_BLUETOOTHAUDIOSINK_AUDIOCODECITERATOR>, RPCIteratorTypeInstance4DC148F9Proxy, RPCIteratorTypeInstance4DC148F9Stub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IBluetoothAudioSink::drmscheme, Exchange::ID_BLUETOOTHAUDIOSINK_DRMSCHEMEITERATOR>, RPCIteratorTypeInstanceF1CB1513Proxy, RPCIteratorTypeInstanceF1CB1513Stub>();
