...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const Core::instance_id parameter_bedbcdf1Implementation = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_bedbcdf1 = nullptr;
            ProxyStub::UnknownProxy* parameter_bedbcdf1Proxy = nullptr;
            if (parameter_bedbcdf1Implementation != 0) {
                parameter_bedbcdf1Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_bedbcdf1Implementation, false, _parameter_bedbcdf1);

                ASSERT((_parameter_bedbcdf1 != nullptr) && (parameter_bedbcdf1Proxy != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_bedbcdf1);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_bedbcdf1Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_bedbcdf1Proxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_8aead2ccImplementation = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_8aead2cc = nullptr;
            ProxyStub::UnknownProxy* parameter_8aead2ccProxy = nullptr;
            if (parameter_8aead2ccImplementation != 0) {
                parameter_8aead2ccProxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_8aead2ccImplementation, false, _parameter_8aead2cc);

                ASSERT((_parameter_8aead2cc != nullptr) && (parameter_8aead2ccProxy != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_8aead2cc);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_8aead2ccProxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_8aead2ccProxy, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_bedbcdf1) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_bedbcdf1));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_8aead2cc) override
        {
            IPCMessage message(BaseClass::Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_8aead2cc));
