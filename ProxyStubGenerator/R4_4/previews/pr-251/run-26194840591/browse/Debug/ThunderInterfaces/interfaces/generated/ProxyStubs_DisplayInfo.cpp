...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstanceA741B85E interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceA741B85EStubMethods[] = {
        // (0) virtual bool Next(Exchange::IHDRProperties::HDRType&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceA741B85EStubMethods

    //
    // RPC::IIteratorTypeInstanceF7F4AE24 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceF7F4AE24StubMethods[] = {
        // (0) virtual bool Next(Exchange::IDisplayProperties::ColorimetryType&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceF7F4AE24StubMethods
    ...
    ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_f3b975ccImplementation = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_f3b975cc = nullptr;
            ProxyStub::UnknownProxy* parameter_f3b975ccProxy = nullptr;
            if (parameter_f3b975ccImplementation != 0) {
                parameter_f3b975ccProxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_f3b975ccImplementation, false, _parameter_f3b975cc);

                ASSERT((_parameter_f3b975cc != nullptr) && (parameter_f3b975ccProxy != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_f3b975cc);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_f3b975ccProxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_f3b975ccProxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_ce4866e2Implementation = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_ce4866e2 = nullptr;
            ProxyStub::UnknownProxy* parameter_ce4866e2Proxy = nullptr;
            if (parameter_ce4866e2Implementation != 0) {
                parameter_ce4866e2Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_ce4866e2Implementation, false, _parameter_ce4866e2);

                ASSERT((_parameter_ce4866e2 != nullptr) && (parameter_ce4866e2Proxy != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_ce4866e2);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_ce4866e2Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_ce4866e2Proxy, message->Response());
            }
        },
    ...
    //
    // RPC::IIteratorTypeInstanceA741B85E interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IHDRProperties::HDRType&) = 0
    //  (1) virtual bool Previous(Exchange::IHDRProperties::HDRType&) = 0
    ...
    class RPCIteratorTypeInstanceA741B85EProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>> {
    public:
        RPCIteratorTypeInstanceA741B85EProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstanceA741B85EProxy

    //
    // RPC::IIteratorTypeInstanceF7F4AE24 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IDisplayProperties::ColorimetryType&) = 0
    //  (1) virtual bool Previous(Exchange::IDisplayProperties::ColorimetryType&) = 0
    ...
    class RPCIteratorTypeInstanceF7F4AE24Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>> {
    public:
        RPCIteratorTypeInstanceF7F4AE24Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstanceF7F4AE24Proxy
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_f3b975cc) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_f3b975cc));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_ce4866e2) override
        {
            IPCMessage message(BaseClass::Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_ce4866e2));
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>, RPCIteratorTypeInstanceA741B85EStubMethods> RPCIteratorTypeInstanceA741B85EStub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>, RPCIteratorTypeInstanceF7F4AE24StubMethods> RPCIteratorTypeInstanceF7F4AE24Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>, RPCIteratorTypeInstanceA741B85EProxy, RPCIteratorTypeInstanceA741B85EStub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>, RPCIteratorTypeInstanceF7F4AE24Proxy, RPCIteratorTypeInstanceF7F4AE24Stub>();
