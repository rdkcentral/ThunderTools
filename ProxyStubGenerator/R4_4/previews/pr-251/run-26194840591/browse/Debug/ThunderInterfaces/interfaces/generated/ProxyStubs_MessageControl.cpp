...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstanceAB496F76 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceAB496F76StubMethods[] = {
        // (0) virtual bool Next(Exchange::IMessageControl::Control&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceAB496F76StubMethods
    ...
    //
    // RPC::IIteratorTypeInstanceAB496F76 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IMessageControl::Control&) = 0
    //  (1) virtual bool Previous(Exchange::IMessageControl::Control&) = 0
    ...
    class RPCIteratorTypeInstanceAB496F76Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IMessageControl::Control, Exchange::ID_MESSAGE_CONTROL_ITERATOR>> {
    public:
        RPCIteratorTypeInstanceAB496F76Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstanceAB496F76Proxy
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IMessageControl::Control, Exchange::ID_MESSAGE_CONTROL_ITERATOR>, RPCIteratorTypeInstanceAB496F76StubMethods> RPCIteratorTypeInstanceAB496F76Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IMessageControl::Control, Exchange::ID_MESSAGE_CONTROL_ITERATOR>, RPCIteratorTypeInstanceAB496F76Proxy, RPCIteratorTypeInstanceAB496F76Stub>();
