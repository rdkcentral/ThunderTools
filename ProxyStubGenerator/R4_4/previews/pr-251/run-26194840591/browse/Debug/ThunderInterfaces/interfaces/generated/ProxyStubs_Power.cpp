...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangePowerStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Exchange::IPower::PCState _parameter_14dc4d19 = reader.Number<Exchange::IPower::PCState>();
            const uint32_t _parameter_9ed6adb0 = reader.Number<uint32_t>();

            uint32_t result = implementation->SetState(_parameter_14dc4d19, _parameter_9ed6adb0);
    ...
    public:
        ...
        uint32_t SetState(const Exchange::IPower::PCState _parameter_14dc4d19, const uint32_t _parameter_9ed6adb0) override
        {
            IPCMessage message(BaseClass::Message(3));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Exchange::IPower::PCState>(_parameter_14dc4d19);
            writer.Number<uint32_t>(_parameter_9ed6adb0);
