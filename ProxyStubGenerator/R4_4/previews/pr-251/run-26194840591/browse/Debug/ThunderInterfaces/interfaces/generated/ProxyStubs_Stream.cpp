...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const Core::instance_id parameter_77528c18Implementation = reader.Number<Core::instance_id>();

            Exchange::IStream::ICallback* _parameter_77528c18 = nullptr;
            ProxyStub::UnknownProxy* parameter_77528c18Proxy = nullptr;
            if (parameter_77528c18Implementation != 0) {
                parameter_77528c18Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_77528c18Implementation, false, _parameter_77528c18);

                ASSERT((_parameter_77528c18 != nullptr) && (parameter_77528c18Proxy != nullptr));
            }

            implementation->Callback(_parameter_77528c18);

            if (parameter_77528c18Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_77528c18Proxy, message->Response());
            }
        },
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_77528c18) override
        {
            IPCMessage message(BaseClass::Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_77528c18));
