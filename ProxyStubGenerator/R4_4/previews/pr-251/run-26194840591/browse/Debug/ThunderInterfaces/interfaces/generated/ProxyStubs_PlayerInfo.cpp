...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstance82C72E1E interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance82C72E1EStubMethods[] = {
        // (0) virtual bool Next(Exchange::IPlayerProperties::AudioCodec&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstance82C72E1EStubMethods

    //
    // RPC::IIteratorTypeInstance874B4541 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance874B4541StubMethods[] = {
        // (0) virtual bool Next(Exchange::IPlayerProperties::VideoCodec&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstance874B4541StubMethods
    ...
    //
    // RPC::IIteratorTypeInstance82C72E1E interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IPlayerProperties::AudioCodec&) = 0
    //  (1) virtual bool Previous(Exchange::IPlayerProperties::AudioCodec&) = 0
    ...
    class RPCIteratorTypeInstance82C72E1EProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPlayerProperties::AudioCodec, Exchange::ID_PLAYER_PROPERTIES_AUDIO>> {
    public:
        RPCIteratorTypeInstance82C72E1EProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstance82C72E1EProxy

    //
    // RPC::IIteratorTypeInstance874B4541 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IPlayerProperties::VideoCodec&) = 0
    //  (1) virtual bool Previous(Exchange::IPlayerProperties::VideoCodec&) = 0
    ...
    class RPCIteratorTypeInstance874B4541Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPlayerProperties::VideoCodec, Exchange::ID_PLAYER_PROPERTIES_VIDEO>> {
    public:
        RPCIteratorTypeInstance874B4541Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstance874B4541Proxy
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IPlayerProperties::AudioCodec, Exchange::ID_PLAYER_PROPERTIES_AUDIO>, RPCIteratorTypeInstance82C72E1EStubMethods> RPCIteratorTypeInstance82C72E1EStub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IPlayerProperties::VideoCodec, Exchange::ID_PLAYER_PROPERTIES_VIDEO>, RPCIteratorTypeInstance874B4541StubMethods> RPCIteratorTypeInstance874B4541Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IPlayerProperties::AudioCodec, Exchange::ID_PLAYER_PROPERTIES_AUDIO>, RPCIteratorTypeInstance82C72E1EProxy, RPCIteratorTypeInstance82C72E1EStub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IPlayerProperties::VideoCodec, Exchange::ID_PLAYER_PROPERTIES_VIDEO>, RPCIteratorTypeInstance874B4541Proxy, RPCIteratorTypeInstance874B4541Stub>();
