...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ShellStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const IShell::reason _parameter_d1ff5d04 = reader.Number<IShell::reason>();

            Core::hresult result = implementation->Activate(_parameter_d1ff5d04);
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const IShell::reason _parameter_4e197811 = reader.Number<IShell::reason>();

            Core::hresult result = implementation->Deactivate(_parameter_4e197811);
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const IShell::reason _parameter_e2c65818 = reader.Number<IShell::reason>();

            Core::hresult result = implementation->Unavailable(_parameter_e2c65818);
    ...
    public:
        ...
        Core::hresult Activate(const IShell::reason _parameter_d1ff5d04) override
        {
            IPCMessage message(BaseClass::Message(34));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<IShell::reason>(_parameter_d1ff5d04);
        ...
        Core::hresult Deactivate(const IShell::reason _parameter_4e197811) override
        {
            IPCMessage message(BaseClass::Message(35));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<IShell::reason>(_parameter_4e197811);
        ...
        Core::hresult Unavailable(const IShell::reason _parameter_e2c65818) override
        {
            IPCMessage message(BaseClass::Message(36));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<IShell::reason>(_parameter_e2c65818);
