...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const Core::instance_id parameter_79dcc05bImplementation = reader.Number<Core::instance_id>();

            Exchange::IStream::ICallback* _parameter_79dcc05b = nullptr;
            ProxyStub::UnknownProxy* parameter_79dcc05bProxy = nullptr;
            if (parameter_79dcc05bImplementation != 0) {
                parameter_79dcc05bProxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_79dcc05bImplementation, false, _parameter_79dcc05b);

                ASSERT((_parameter_79dcc05b != nullptr) && (parameter_79dcc05bProxy != nullptr));
            }

            implementation->Callback(_parameter_79dcc05b);

            if (parameter_79dcc05bProxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_79dcc05bProxy, message->Response());
            }
        },
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_79dcc05b) override
        {
            IPCMessage message(BaseClass::Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_79dcc05b));
