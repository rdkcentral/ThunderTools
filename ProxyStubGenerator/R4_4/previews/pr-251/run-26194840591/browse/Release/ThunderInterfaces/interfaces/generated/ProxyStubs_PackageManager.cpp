...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstanceB6AA2BAE interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceB6AA2BAEStubMethods[] = {
        // (0) virtual bool Next(string&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceB6AA2BAEStubMethods

    //
    // RPC::IIteratorTypeInstanceB56A671C interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceB56A671CStubMethods[] = {
        // (0) virtual bool Next(Exchange::IPackageManager::KeyValue&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceB56A671CStubMethods

    //
    // RPC::IIteratorTypeInstanceF36FE896 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceF36FE896StubMethods[] = {
        // (0) virtual bool Next(Exchange::IPackageManager::PackageKey&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceF36FE896StubMethods
    ...
    //
    // RPC::IIteratorTypeInstanceB6AA2BAE interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(string&) = 0
    //  (1) virtual bool Previous(string&) = 0
    ...
    class RPCIteratorTypeInstanceB6AA2BAEProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>> {
    public:
        RPCIteratorTypeInstanceB6AA2BAEProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstanceB6AA2BAEProxy

    //
    // RPC::IIteratorTypeInstanceB56A671C interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IPackageManager::KeyValue&) = 0
    //  (1) virtual bool Previous(Exchange::IPackageManager::KeyValue&) = 0
    ...
    class RPCIteratorTypeInstanceB56A671CProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPackageManager::KeyValue, Exchange::ID_PACKAGEMANAGER_KEY_VALUE_ITERATOR>> {
    public:
        RPCIteratorTypeInstanceB56A671CProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstanceB56A671CProxy

    //
    // RPC::IIteratorTypeInstanceF36FE896 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IPackageManager::PackageKey&) = 0
    //  (1) virtual bool Previous(Exchange::IPackageManager::PackageKey&) = 0
    ...
    class RPCIteratorTypeInstanceF36FE896Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPackageManager::PackageKey, Exchange::ID_PACKAGEMANAGER_PACKAGE_KEY_ITERATOR>> {
    public:
        RPCIteratorTypeInstanceF36FE896Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstanceF36FE896Proxy
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstanceB6AA2BAEStubMethods> RPCIteratorTypeInstanceB6AA2BAEStub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IPackageManager::KeyValue, Exchange::ID_PACKAGEMANAGER_KEY_VALUE_ITERATOR>, RPCIteratorTypeInstanceB56A671CStubMethods> RPCIteratorTypeInstanceB56A671CStub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IPackageManager::PackageKey, Exchange::ID_PACKAGEMANAGER_PACKAGE_KEY_ITERATOR>, RPCIteratorTypeInstanceF36FE896StubMethods> RPCIteratorTypeInstanceF36FE896Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstanceB6AA2BAEProxy, RPCIteratorTypeInstanceB6AA2BAEStub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IPackageManager::KeyValue, Exchange::ID_PACKAGEMANAGER_KEY_VALUE_ITERATOR>, RPCIteratorTypeInstanceB56A671CProxy, RPCIteratorTypeInstanceB56A671CStub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IPackageManager::PackageKey, Exchange::ID_PACKAGEMANAGER_PACKAGE_KEY_ITERATOR>, RPCIteratorTypeInstanceF36FE896Proxy, RPCIteratorTypeInstanceF36FE896Stub>();
