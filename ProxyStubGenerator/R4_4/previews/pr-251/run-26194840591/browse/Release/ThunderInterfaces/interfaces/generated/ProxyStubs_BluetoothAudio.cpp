...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstanceA6936E59 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceA6936E59StubMethods[] = {
        // (0) virtual bool Next(Exchange::IBluetoothAudioSink::audiocodec&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceA6936E59StubMethods

    //
    // RPC::IIteratorTypeInstanceEC2F4424 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceEC2F4424StubMethods[] = {
        // (0) virtual bool Next(Exchange::IBluetoothAudioSink::drmscheme&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceEC2F4424StubMethods
    ...
    //
    // RPC::IIteratorTypeInstanceA6936E59 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IBluetoothAudioSink::audiocodec&) = 0
    //  (1) virtual bool Previous(Exchange::IBluetoothAudioSink::audiocodec&) = 0
    ...
    class RPCIteratorTypeInstanceA6936E59Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IBluetoothAudioSink::audiocodec, Exchange::ID_BLUETOOTHAUDIOSINK_AUDIOCODECITERATOR>> {
    public:
        RPCIteratorTypeInstanceA6936E59Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstanceA6936E59Proxy

    //
    // RPC::IIteratorTypeInstanceEC2F4424 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IBluetoothAudioSink::drmscheme&) = 0
    //  (1) virtual bool Previous(Exchange::IBluetoothAudioSink::drmscheme&) = 0
    ...
    class RPCIteratorTypeInstanceEC2F4424Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IBluetoothAudioSink::drmscheme, Exchange::ID_BLUETOOTHAUDIOSINK_DRMSCHEMEITERATOR>> {
    public:
        RPCIteratorTypeInstanceEC2F4424Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstanceEC2F4424Proxy
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IBluetoothAudioSink::audiocodec, Exchange::ID_BLUETOOTHAUDIOSINK_AUDIOCODECITERATOR>, RPCIteratorTypeInstanceA6936E59StubMethods> RPCIteratorTypeInstanceA6936E59Stub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IBluetoothAudioSink::drmscheme, Exchange::ID_BLUETOOTHAUDIOSINK_DRMSCHEMEITERATOR>, RPCIteratorTypeInstanceEC2F4424StubMethods> RPCIteratorTypeInstanceEC2F4424Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IBluetoothAudioSink::audiocodec, Exchange::ID_BLUETOOTHAUDIOSINK_AUDIOCODECITERATOR>, RPCIteratorTypeInstanceA6936E59Proxy, RPCIteratorTypeInstanceA6936E59Stub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IBluetoothAudioSink::drmscheme, Exchange::ID_BLUETOOTHAUDIOSINK_DRMSCHEMEITERATOR>, RPCIteratorTypeInstanceEC2F4424Proxy, RPCIteratorTypeInstanceEC2F4424Stub>();
