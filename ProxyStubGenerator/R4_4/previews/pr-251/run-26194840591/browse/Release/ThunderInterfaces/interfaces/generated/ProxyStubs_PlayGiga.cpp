...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_16d8d3c8 = reader.Text();
            const string _parameter_11112209 = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_16d8d3c8), static_cast<const string&>(_parameter_11112209));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_16d8d3c8, const string& _parameter_11112209) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(static_cast<const string&>(_parameter_16d8d3c8));
            writer.Text(static_cast<const string&>(_parameter_11112209));
