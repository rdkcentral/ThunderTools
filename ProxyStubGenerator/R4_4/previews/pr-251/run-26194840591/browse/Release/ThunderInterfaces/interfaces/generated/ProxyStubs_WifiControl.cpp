...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstance8BC19688 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance8BC19688StubMethods[] = {
        // (0) virtual bool Next(Exchange::IWifiControl::SecurityInfo&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstance8BC19688StubMethods

    //
    // RPC::IIteratorTypeInstanceE8CD5FD0 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceE8CD5FD0StubMethods[] = {
        // (0) virtual bool Next(Exchange::IWifiControl::NetworkInfo&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceE8CD5FD0StubMethods

    //
    // RPC::IIteratorTypeInstance294E831B interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance294E831BStubMethods[] = {
        // (0) virtual bool Next(string&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstance294E831BStubMethods
    ...
    //
    // RPC::IIteratorTypeInstance8BC19688 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IWifiControl::SecurityInfo&) = 0
    //  (1) virtual bool Previous(Exchange::IWifiControl::SecurityInfo&) = 0
    ...
    class RPCIteratorTypeInstance8BC19688Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IWifiControl::SecurityInfo, Exchange::ID_WIFICONTROL_SECURITY_INFO_ITERATOR>> {
    public:
        RPCIteratorTypeInstance8BC19688Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstance8BC19688Proxy

    //
    // RPC::IIteratorTypeInstanceE8CD5FD0 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IWifiControl::NetworkInfo&) = 0
    //  (1) virtual bool Previous(Exchange::IWifiControl::NetworkInfo&) = 0
    ...
    class RPCIteratorTypeInstanceE8CD5FD0Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IWifiControl::NetworkInfo, Exchange::ID_WIFICONTROL_NETWORK_INFO_ITERATOR>> {
    public:
        RPCIteratorTypeInstanceE8CD5FD0Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstanceE8CD5FD0Proxy

    //
    // RPC::IIteratorTypeInstance294E831B interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(string&) = 0
    //  (1) virtual bool Previous(string&) = 0
    ...
    class RPCIteratorTypeInstance294E831BProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>> {
    public:
        RPCIteratorTypeInstance294E831BProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstance294E831BProxy
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IWifiControl::SecurityInfo, Exchange::ID_WIFICONTROL_SECURITY_INFO_ITERATOR>, RPCIteratorTypeInstance8BC19688StubMethods> RPCIteratorTypeInstance8BC19688Stub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IWifiControl::NetworkInfo, Exchange::ID_WIFICONTROL_NETWORK_INFO_ITERATOR>, RPCIteratorTypeInstanceE8CD5FD0StubMethods> RPCIteratorTypeInstanceE8CD5FD0Stub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstance294E831BStubMethods> RPCIteratorTypeInstance294E831BStub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IWifiControl::SecurityInfo, Exchange::ID_WIFICONTROL_SECURITY_INFO_ITERATOR>, RPCIteratorTypeInstance8BC19688Proxy, RPCIteratorTypeInstance8BC19688Stub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IWifiControl::NetworkInfo, Exchange::ID_WIFICONTROL_NETWORK_INFO_ITERATOR>, RPCIteratorTypeInstanceE8CD5FD0Proxy, RPCIteratorTypeInstanceE8CD5FD0Stub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstance294E831BProxy, RPCIteratorTypeInstance294E831BStub>();
