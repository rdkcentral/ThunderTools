...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangePowerStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Exchange::IPower::PCState _parameter_71bd60f7 = reader.Number<Exchange::IPower::PCState>();
            const uint32_t _parameter_09901e3c = reader.Number<uint32_t>();

            uint32_t result = implementation->SetState(_parameter_71bd60f7, _parameter_09901e3c);
    ...
    public:
        ...
        uint32_t SetState(const Exchange::IPower::PCState _parameter_71bd60f7, const uint32_t _parameter_09901e3c) override
        {
            IPCMessage message(BaseClass::Message(3));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Exchange::IPower::PCState>(_parameter_71bd60f7);
            writer.Number<uint32_t>(_parameter_09901e3c);
