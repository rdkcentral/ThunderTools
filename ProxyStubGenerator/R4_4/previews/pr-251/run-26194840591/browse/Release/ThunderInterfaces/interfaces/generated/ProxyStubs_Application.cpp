...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangeApplicationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Exchange::IApplication::launchpointtype _parameter_1fa48edf = reader.Number<Exchange::IApplication::launchpointtype>();

            uint32_t result = implementation->LaunchPoint(static_cast<const Exchange::IApplication::launchpointtype&>(_parameter_1fa48edf));
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const bool _parameter_94fd3e59 = reader.Boolean();

            uint32_t result = implementation->Visible(static_cast<const bool&>(_parameter_94fd3e59));
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_f1296095 = reader.Text();

            uint32_t result = implementation->Language(static_cast<const string&>(_parameter_f1296095));
    ...
    public:
        ...
        uint32_t LaunchPoint(const Exchange::IApplication::launchpointtype& _parameter_1fa48edf) override
        {
            IPCMessage message(BaseClass::Message(6));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Exchange::IApplication::launchpointtype>(static_cast<const Exchange::IApplication::launchpointtype&>(_parameter_1fa48edf));
        ...
        uint32_t Visible(const bool& _parameter_94fd3e59) override
        {
            IPCMessage message(BaseClass::Message(8));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Boolean(static_cast<const bool&>(_parameter_94fd3e59));
        ...
        uint32_t Language(const string& _parameter_f1296095) override
        {
            IPCMessage message(BaseClass::Message(10));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(static_cast<const string&>(_parameter_f1296095));
