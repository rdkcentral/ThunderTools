...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstance8669F5B9 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance8669F5B9StubMethods[] = {
        // (0) virtual bool Next(Exchange::IHDRProperties::HDRType&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstance8669F5B9StubMethods

    //
    // RPC::IIteratorTypeInstance15140849 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance15140849StubMethods[] = {
        // (0) virtual bool Next(Exchange::IDisplayProperties::ColorimetryType&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstance15140849StubMethods
    ...
    ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_f52ba5adImplementation = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_f52ba5ad = nullptr;
            ProxyStub::UnknownProxy* parameter_f52ba5adProxy = nullptr;
            if (parameter_f52ba5adImplementation != 0) {
                parameter_f52ba5adProxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_f52ba5adImplementation, false, _parameter_f52ba5ad);

                ASSERT((_parameter_f52ba5ad != nullptr) && (parameter_f52ba5adProxy != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_f52ba5ad);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_f52ba5adProxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_f52ba5adProxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_494d3e86Implementation = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_494d3e86 = nullptr;
            ProxyStub::UnknownProxy* parameter_494d3e86Proxy = nullptr;
            if (parameter_494d3e86Implementation != 0) {
                parameter_494d3e86Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_494d3e86Implementation, false, _parameter_494d3e86);

                ASSERT((_parameter_494d3e86 != nullptr) && (parameter_494d3e86Proxy != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_494d3e86);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_494d3e86Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_494d3e86Proxy, message->Response());
            }
        },
    ...
    //
    // RPC::IIteratorTypeInstance8669F5B9 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IHDRProperties::HDRType&) = 0
    //  (1) virtual bool Previous(Exchange::IHDRProperties::HDRType&) = 0
    ...
    class RPCIteratorTypeInstance8669F5B9Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>> {
    public:
        RPCIteratorTypeInstance8669F5B9Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstance8669F5B9Proxy

    //
    // RPC::IIteratorTypeInstance15140849 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IDisplayProperties::ColorimetryType&) = 0
    //  (1) virtual bool Previous(Exchange::IDisplayProperties::ColorimetryType&) = 0
    ...
    class RPCIteratorTypeInstance15140849Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>> {
    public:
        RPCIteratorTypeInstance15140849Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstance15140849Proxy
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_f52ba5ad) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_f52ba5ad));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_494d3e86) override
        {
            IPCMessage message(BaseClass::Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_494d3e86));
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>, RPCIteratorTypeInstance8669F5B9StubMethods> RPCIteratorTypeInstance8669F5B9Stub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>, RPCIteratorTypeInstance15140849StubMethods> RPCIteratorTypeInstance15140849Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>, RPCIteratorTypeInstance8669F5B9Proxy, RPCIteratorTypeInstance8669F5B9Stub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>, RPCIteratorTypeInstance15140849Proxy, RPCIteratorTypeInstance15140849Stub>();
