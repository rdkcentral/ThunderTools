    ...
    public:
        ...
        Exchange::IDIALServer::IApplication* Application(const string& _name) override
        {
            ...
            if (hresult == Core::ERROR_NONE) {
                ...
                result = reinterpret_cast<Exchange::IDIALServer::IApplication*>(UnknownProxyType::Interface(reader.Number<Core::instance_id>(), Exchange::IDIALServer::IApplication::ID));
            } else {
