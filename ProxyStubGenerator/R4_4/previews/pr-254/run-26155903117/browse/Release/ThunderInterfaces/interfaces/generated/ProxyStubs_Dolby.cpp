...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const Core::instance_id parameter_31a72256Implementation = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_31a72256 = nullptr;
            ProxyStub::UnknownProxy* parameter_31a72256Proxy = nullptr;
            if (parameter_31a72256Implementation != 0) {
                parameter_31a72256Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_31a72256Implementation, false, _parameter_31a72256);

                ASSERT((_parameter_31a72256 != nullptr) && (parameter_31a72256Proxy != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_31a72256);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_31a72256Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_31a72256Proxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_c846c137Implementation = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_c846c137 = nullptr;
            ProxyStub::UnknownProxy* parameter_c846c137Proxy = nullptr;
            if (parameter_c846c137Implementation != 0) {
                parameter_c846c137Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_c846c137Implementation, false, _parameter_c846c137);

                ASSERT((_parameter_c846c137 != nullptr) && (parameter_c846c137Proxy != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_c846c137);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_c846c137Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_c846c137Proxy, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_31a72256) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_31a72256));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_c846c137) override
        {
            IPCMessage message(BaseClass::Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_c846c137));
