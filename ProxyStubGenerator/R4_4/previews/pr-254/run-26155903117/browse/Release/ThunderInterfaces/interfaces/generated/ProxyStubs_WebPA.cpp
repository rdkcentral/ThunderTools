...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const Core::instance_id parameter_edcea1efImplementation = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_edcea1ef = nullptr;
            ProxyStub::UnknownProxy* parameter_edcea1efProxy = nullptr;
            if (parameter_edcea1efImplementation != 0) {
                parameter_edcea1efProxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_edcea1efImplementation, false, _parameter_edcea1ef);

                ASSERT((_parameter_edcea1ef != nullptr) && (parameter_edcea1efProxy != nullptr));
            }

            uint32_t result = implementation->Initialize(_parameter_edcea1ef);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_edcea1efProxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_edcea1efProxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_9eb34437Implementation = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_9eb34437 = nullptr;
            ProxyStub::UnknownProxy* parameter_9eb34437Proxy = nullptr;
            if (parameter_9eb34437Implementation != 0) {
                parameter_9eb34437Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_9eb34437Implementation, false, _parameter_9eb34437);

                ASSERT((_parameter_9eb34437 != nullptr) && (parameter_9eb34437Proxy != nullptr));
            }

            implementation->Deinitialize(_parameter_9eb34437);

            if (parameter_9eb34437Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_9eb34437Proxy, message->Response());
            }
        },
    ...
    ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_19959f52Implementation = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_19959f52 = nullptr;
            ProxyStub::UnknownProxy* parameter_19959f52Proxy = nullptr;
            if (parameter_19959f52Implementation != 0) {
                parameter_19959f52Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_19959f52Implementation, false, _parameter_19959f52);

                ASSERT((_parameter_19959f52 != nullptr) && (parameter_19959f52Proxy != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_19959f52);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_19959f52Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_19959f52Proxy, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_edcea1ef) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_edcea1ef));
        ...
        void Deinitialize(PluginHost::IShell* _parameter_9eb34437) override
        {
            IPCMessage message(BaseClass::Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_9eb34437));
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_19959f52) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_19959f52));
