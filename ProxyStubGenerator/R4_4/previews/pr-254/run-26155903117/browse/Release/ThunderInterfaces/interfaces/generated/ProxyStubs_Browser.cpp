...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstance6FCF35BC interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance6FCF35BCStubMethods[] = {
        // (0) virtual bool Next(string&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstance6FCF35BCStubMethods
    ...
    //
    // RPC::IIteratorTypeInstance6FCF35BC interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(string&) = 0
    //  (1) virtual bool Previous(string&) = 0
    ...
    class RPCIteratorTypeInstance6FCF35BCProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>> {
    public:
        RPCIteratorTypeInstance6FCF35BCProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstance6FCF35BCProxy
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstance6FCF35BCStubMethods> RPCIteratorTypeInstance6FCF35BCStub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstance6FCF35BCProxy, RPCIteratorTypeInstance6FCF35BCStub>();
