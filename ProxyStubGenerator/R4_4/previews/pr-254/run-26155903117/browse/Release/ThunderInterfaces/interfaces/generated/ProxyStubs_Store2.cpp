...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstance618A6602 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance618A6602StubMethods[] = {
        // (0) virtual bool Next(string&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstance618A6602StubMethods

    //
    // RPC::IIteratorTypeInstanceD6A1BC64 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceD6A1BC64StubMethods[] = {
        // (0) virtual bool Next(Exchange::IStoreInspector::NamespaceSize&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceD6A1BC64StubMethods
    ...
    //
    // RPC::IIteratorTypeInstance618A6602 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(string&) = 0
    //  (1) virtual bool Previous(string&) = 0
    ...
    class RPCIteratorTypeInstance618A6602Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>> {
    public:
        RPCIteratorTypeInstance618A6602Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstance618A6602Proxy

    //
    // RPC::IIteratorTypeInstanceD6A1BC64 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IStoreInspector::NamespaceSize&) = 0
    //  (1) virtual bool Previous(Exchange::IStoreInspector::NamespaceSize&) = 0
    ...
    class RPCIteratorTypeInstanceD6A1BC64Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IStoreInspector::NamespaceSize, Exchange::ID_STORE_INSPECTOR_NAMESPACE_SIZE_ITERATOR>> {
    public:
        RPCIteratorTypeInstanceD6A1BC64Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstanceD6A1BC64Proxy
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstance618A6602StubMethods> RPCIteratorTypeInstance618A6602Stub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IStoreInspector::NamespaceSize, Exchange::ID_STORE_INSPECTOR_NAMESPACE_SIZE_ITERATOR>, RPCIteratorTypeInstanceD6A1BC64StubMethods> RPCIteratorTypeInstanceD6A1BC64Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstance618A6602Proxy, RPCIteratorTypeInstance618A6602Stub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IStoreInspector::NamespaceSize, Exchange::ID_STORE_INSPECTOR_NAMESPACE_SIZE_ITERATOR>, RPCIteratorTypeInstanceD6A1BC64Proxy, RPCIteratorTypeInstanceD6A1BC64Stub>();
