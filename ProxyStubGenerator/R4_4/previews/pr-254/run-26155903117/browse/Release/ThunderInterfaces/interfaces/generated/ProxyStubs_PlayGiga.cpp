...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_873a4e8d = reader.Text();
            const string _parameter_caddc0b4 = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_873a4e8d), static_cast<const string&>(_parameter_caddc0b4));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_873a4e8d, const string& _parameter_caddc0b4) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(static_cast<const string&>(_parameter_873a4e8d));
            writer.Text(static_cast<const string&>(_parameter_caddc0b4));
