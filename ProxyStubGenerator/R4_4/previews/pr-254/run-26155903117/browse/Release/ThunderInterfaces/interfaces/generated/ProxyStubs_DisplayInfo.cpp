...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstanceA63D45D6 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceA63D45D6StubMethods[] = {
        // (0) virtual bool Next(Exchange::IHDRProperties::HDRType&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceA63D45D6StubMethods

    //
    // RPC::IIteratorTypeInstanceC62F28C7 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceC62F28C7StubMethods[] = {
        // (0) virtual bool Next(Exchange::IDisplayProperties::ColorimetryType&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceC62F28C7StubMethods
    ...
    ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_8643cc49Implementation = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_8643cc49 = nullptr;
            ProxyStub::UnknownProxy* parameter_8643cc49Proxy = nullptr;
            if (parameter_8643cc49Implementation != 0) {
                parameter_8643cc49Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_8643cc49Implementation, false, _parameter_8643cc49);

                ASSERT((_parameter_8643cc49 != nullptr) && (parameter_8643cc49Proxy != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_8643cc49);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_8643cc49Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_8643cc49Proxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_22b0001dImplementation = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_22b0001d = nullptr;
            ProxyStub::UnknownProxy* parameter_22b0001dProxy = nullptr;
            if (parameter_22b0001dImplementation != 0) {
                parameter_22b0001dProxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_22b0001dImplementation, false, _parameter_22b0001d);

                ASSERT((_parameter_22b0001d != nullptr) && (parameter_22b0001dProxy != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_22b0001d);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_22b0001dProxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_22b0001dProxy, message->Response());
            }
        },
    ...
    //
    // RPC::IIteratorTypeInstanceA63D45D6 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IHDRProperties::HDRType&) = 0
    //  (1) virtual bool Previous(Exchange::IHDRProperties::HDRType&) = 0
    ...
    class RPCIteratorTypeInstanceA63D45D6Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>> {
    public:
        RPCIteratorTypeInstanceA63D45D6Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstanceA63D45D6Proxy

    //
    // RPC::IIteratorTypeInstanceC62F28C7 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IDisplayProperties::ColorimetryType&) = 0
    //  (1) virtual bool Previous(Exchange::IDisplayProperties::ColorimetryType&) = 0
    ...
    class RPCIteratorTypeInstanceC62F28C7Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>> {
    public:
        RPCIteratorTypeInstanceC62F28C7Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstanceC62F28C7Proxy
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_8643cc49) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_8643cc49));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_22b0001d) override
        {
            IPCMessage message(BaseClass::Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_22b0001d));
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>, RPCIteratorTypeInstanceA63D45D6StubMethods> RPCIteratorTypeInstanceA63D45D6Stub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>, RPCIteratorTypeInstanceC62F28C7StubMethods> RPCIteratorTypeInstanceC62F28C7Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>, RPCIteratorTypeInstanceA63D45D6Proxy, RPCIteratorTypeInstanceA63D45D6Stub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>, RPCIteratorTypeInstanceC62F28C7Proxy, RPCIteratorTypeInstanceC62F28C7Stub>();
