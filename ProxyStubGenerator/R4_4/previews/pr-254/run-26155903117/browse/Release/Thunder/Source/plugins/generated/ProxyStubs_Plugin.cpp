...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler CompositPluginStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_c0fd52a5Implementation = reader.Number<Core::instance_id>();

            ICompositPlugin::INotification* _parameter_c0fd52a5 = nullptr;
            ProxyStub::UnknownProxy* parameter_c0fd52a5Proxy = nullptr;
            if (parameter_c0fd52a5Implementation != 0) {
                parameter_c0fd52a5Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_c0fd52a5Implementation, false, _parameter_c0fd52a5);

                ASSERT((_parameter_c0fd52a5 != nullptr) && (parameter_c0fd52a5Proxy != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_c0fd52a5);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_c0fd52a5Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_c0fd52a5Proxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_70e807aaImplementation = reader.Number<Core::instance_id>();

            ICompositPlugin::INotification* _parameter_70e807aa = nullptr;
            ProxyStub::UnknownProxy* parameter_70e807aaProxy = nullptr;
            if (parameter_70e807aaImplementation != 0) {
                parameter_70e807aaProxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_70e807aaImplementation, false, _parameter_70e807aa);

                ASSERT((_parameter_70e807aa != nullptr) && (parameter_70e807aaProxy != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_70e807aa);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_70e807aaProxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_70e807aaProxy, message->Response());
            }
        }
        , nullptr
    ...
    public:
        ...
        uint32_t Register(ICompositPlugin::INotification* _parameter_c0fd52a5) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_c0fd52a5));
        ...
        uint32_t Unregister(ICompositPlugin::INotification* _parameter_70e807aa) override
        {
            IPCMessage message(BaseClass::Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_70e807aa));
