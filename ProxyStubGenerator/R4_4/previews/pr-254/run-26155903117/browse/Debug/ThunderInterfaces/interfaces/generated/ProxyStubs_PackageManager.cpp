...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstanceEC1250C3 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceEC1250C3StubMethods[] = {
        // (0) virtual bool Next(string&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceEC1250C3StubMethods

    //
    // RPC::IIteratorTypeInstanceDEB1808A interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceDEB1808AStubMethods[] = {
        // (0) virtual bool Next(Exchange::IPackageManager::KeyValue&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceDEB1808AStubMethods

    //
    // RPC::IIteratorTypeInstanceE25091B5 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceE25091B5StubMethods[] = {
        // (0) virtual bool Next(Exchange::IPackageManager::PackageKey&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceE25091B5StubMethods
    ...
    //
    // RPC::IIteratorTypeInstanceEC1250C3 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(string&) = 0
    //  (1) virtual bool Previous(string&) = 0
    ...
    class RPCIteratorTypeInstanceEC1250C3Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>> {
    public:
        RPCIteratorTypeInstanceEC1250C3Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstanceEC1250C3Proxy

    //
    // RPC::IIteratorTypeInstanceDEB1808A interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IPackageManager::KeyValue&) = 0
    //  (1) virtual bool Previous(Exchange::IPackageManager::KeyValue&) = 0
    ...
    class RPCIteratorTypeInstanceDEB1808AProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPackageManager::KeyValue, Exchange::ID_PACKAGEMANAGER_KEY_VALUE_ITERATOR>> {
    public:
        RPCIteratorTypeInstanceDEB1808AProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstanceDEB1808AProxy

    //
    // RPC::IIteratorTypeInstanceE25091B5 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IPackageManager::PackageKey&) = 0
    //  (1) virtual bool Previous(Exchange::IPackageManager::PackageKey&) = 0
    ...
    class RPCIteratorTypeInstanceE25091B5Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPackageManager::PackageKey, Exchange::ID_PACKAGEMANAGER_PACKAGE_KEY_ITERATOR>> {
    public:
        RPCIteratorTypeInstanceE25091B5Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstanceE25091B5Proxy
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstanceEC1250C3StubMethods> RPCIteratorTypeInstanceEC1250C3Stub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IPackageManager::KeyValue, Exchange::ID_PACKAGEMANAGER_KEY_VALUE_ITERATOR>, RPCIteratorTypeInstanceDEB1808AStubMethods> RPCIteratorTypeInstanceDEB1808AStub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IPackageManager::PackageKey, Exchange::ID_PACKAGEMANAGER_PACKAGE_KEY_ITERATOR>, RPCIteratorTypeInstanceE25091B5StubMethods> RPCIteratorTypeInstanceE25091B5Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstanceEC1250C3Proxy, RPCIteratorTypeInstanceEC1250C3Stub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IPackageManager::KeyValue, Exchange::ID_PACKAGEMANAGER_KEY_VALUE_ITERATOR>, RPCIteratorTypeInstanceDEB1808AProxy, RPCIteratorTypeInstanceDEB1808AStub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IPackageManager::PackageKey, Exchange::ID_PACKAGEMANAGER_PACKAGE_KEY_ITERATOR>, RPCIteratorTypeInstanceE25091B5Proxy, RPCIteratorTypeInstanceE25091B5Stub>();
