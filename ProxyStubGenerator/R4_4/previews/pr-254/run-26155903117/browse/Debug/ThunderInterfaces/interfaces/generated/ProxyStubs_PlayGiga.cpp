...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_83266f51 = reader.Text();
            const string _parameter_8b71e687 = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_83266f51), static_cast<const string&>(_parameter_8b71e687));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_83266f51, const string& _parameter_8b71e687) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(static_cast<const string&>(_parameter_83266f51));
            writer.Text(static_cast<const string&>(_parameter_8b71e687));
