...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const Core::instance_id parameter_f3a581aaImplementation = reader.Number<Core::instance_id>();

            Exchange::IStream::ICallback* _parameter_f3a581aa = nullptr;
            ProxyStub::UnknownProxy* parameter_f3a581aaProxy = nullptr;
            if (parameter_f3a581aaImplementation != 0) {
                parameter_f3a581aaProxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_f3a581aaImplementation, false, _parameter_f3a581aa);

                ASSERT((_parameter_f3a581aa != nullptr) && (parameter_f3a581aaProxy != nullptr));
            }

            implementation->Callback(_parameter_f3a581aa);

            if (parameter_f3a581aaProxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_f3a581aaProxy, message->Response());
            }
        },
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_f3a581aa) override
        {
            IPCMessage message(BaseClass::Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_f3a581aa));
