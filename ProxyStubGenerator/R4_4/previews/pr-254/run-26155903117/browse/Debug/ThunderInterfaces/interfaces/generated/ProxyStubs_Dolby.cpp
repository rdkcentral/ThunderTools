...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const Core::instance_id parameter_34e67aa2Implementation = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_34e67aa2 = nullptr;
            ProxyStub::UnknownProxy* parameter_34e67aa2Proxy = nullptr;
            if (parameter_34e67aa2Implementation != 0) {
                parameter_34e67aa2Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_34e67aa2Implementation, false, _parameter_34e67aa2);

                ASSERT((_parameter_34e67aa2 != nullptr) && (parameter_34e67aa2Proxy != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_34e67aa2);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_34e67aa2Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_34e67aa2Proxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_b0493115Implementation = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_b0493115 = nullptr;
            ProxyStub::UnknownProxy* parameter_b0493115Proxy = nullptr;
            if (parameter_b0493115Implementation != 0) {
                parameter_b0493115Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_b0493115Implementation, false, _parameter_b0493115);

                ASSERT((_parameter_b0493115 != nullptr) && (parameter_b0493115Proxy != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_b0493115);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_b0493115Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_b0493115Proxy, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_34e67aa2) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_34e67aa2));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_b0493115) override
        {
            IPCMessage message(BaseClass::Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_b0493115));
