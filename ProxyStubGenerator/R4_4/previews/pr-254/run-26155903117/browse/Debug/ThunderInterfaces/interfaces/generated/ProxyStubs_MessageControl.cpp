...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstanceAEAF30DC interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceAEAF30DCStubMethods[] = {
        // (0) virtual bool Next(Exchange::IMessageControl::Control&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceAEAF30DCStubMethods
    ...
    //
    // RPC::IIteratorTypeInstanceAEAF30DC interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IMessageControl::Control&) = 0
    //  (1) virtual bool Previous(Exchange::IMessageControl::Control&) = 0
    ...
    class RPCIteratorTypeInstanceAEAF30DCProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IMessageControl::Control, Exchange::ID_MESSAGE_CONTROL_ITERATOR>> {
    public:
        RPCIteratorTypeInstanceAEAF30DCProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstanceAEAF30DCProxy
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IMessageControl::Control, Exchange::ID_MESSAGE_CONTROL_ITERATOR>, RPCIteratorTypeInstanceAEAF30DCStubMethods> RPCIteratorTypeInstanceAEAF30DCStub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IMessageControl::Control, Exchange::ID_MESSAGE_CONTROL_ITERATOR>, RPCIteratorTypeInstanceAEAF30DCProxy, RPCIteratorTypeInstanceAEAF30DCStub>();
