...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstance3DCC3EF0 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance3DCC3EF0StubMethods[] = {
        // (0) virtual bool Next(Exchange::IHDRProperties::HDRType&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstance3DCC3EF0StubMethods

    //
    // RPC::IIteratorTypeInstance22262AF5 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance22262AF5StubMethods[] = {
        // (0) virtual bool Next(Exchange::IDisplayProperties::ColorimetryType&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstance22262AF5StubMethods
    ...
    ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_3106f057Implementation = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_3106f057 = nullptr;
            ProxyStub::UnknownProxy* parameter_3106f057Proxy = nullptr;
            if (parameter_3106f057Implementation != 0) {
                parameter_3106f057Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_3106f057Implementation, false, _parameter_3106f057);

                ASSERT((_parameter_3106f057 != nullptr) && (parameter_3106f057Proxy != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_3106f057);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_3106f057Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_3106f057Proxy, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Core::instance_id parameter_0ae53868Implementation = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_0ae53868 = nullptr;
            ProxyStub::UnknownProxy* parameter_0ae53868Proxy = nullptr;
            if (parameter_0ae53868Implementation != 0) {
                parameter_0ae53868Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_0ae53868Implementation, false, _parameter_0ae53868);

                ASSERT((_parameter_0ae53868 != nullptr) && (parameter_0ae53868Proxy != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_0ae53868);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (parameter_0ae53868Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_0ae53868Proxy, message->Response());
            }
        },
    ...
    //
    // RPC::IIteratorTypeInstance3DCC3EF0 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IHDRProperties::HDRType&) = 0
    //  (1) virtual bool Previous(Exchange::IHDRProperties::HDRType&) = 0
    ...
    class RPCIteratorTypeInstance3DCC3EF0Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>> {
    public:
        RPCIteratorTypeInstance3DCC3EF0Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstance3DCC3EF0Proxy

    //
    // RPC::IIteratorTypeInstance22262AF5 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IDisplayProperties::ColorimetryType&) = 0
    //  (1) virtual bool Previous(Exchange::IDisplayProperties::ColorimetryType&) = 0
    ...
    class RPCIteratorTypeInstance22262AF5Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>> {
    public:
        RPCIteratorTypeInstance22262AF5Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstance22262AF5Proxy
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_3106f057) override
        {
            IPCMessage message(BaseClass::Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_3106f057));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_0ae53868) override
        {
            IPCMessage message(BaseClass::Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_0ae53868));
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>, RPCIteratorTypeInstance3DCC3EF0StubMethods> RPCIteratorTypeInstance3DCC3EF0Stub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>, RPCIteratorTypeInstance22262AF5StubMethods> RPCIteratorTypeInstance22262AF5Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IHDRProperties::HDRType, Exchange::ID_HDR_ITERATOR>, RPCIteratorTypeInstance3DCC3EF0Proxy, RPCIteratorTypeInstance3DCC3EF0Stub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IDisplayProperties::ColorimetryType, Exchange::ID_COLORIMETRY_ITERATOR>, RPCIteratorTypeInstance22262AF5Proxy, RPCIteratorTypeInstance22262AF5Stub>();
