...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const Core::instance_id parameter_85ee3dc9Implementation = reader.Number<Core::instance_id>();

            Exchange::IStream::ICallback* _parameter_85ee3dc9 = nullptr;
            ProxyStub::UnknownProxy* parameter_85ee3dc9Proxy = nullptr;
            if (parameter_85ee3dc9Implementation != 0) {
                parameter_85ee3dc9Proxy = RPC::Administrator::Instance().ProxyInstance(channel, parameter_85ee3dc9Implementation, false, _parameter_85ee3dc9);

                ASSERT((_parameter_85ee3dc9 != nullptr) && (parameter_85ee3dc9Proxy != nullptr));
            }

            implementation->Callback(_parameter_85ee3dc9);

            if (parameter_85ee3dc9Proxy != nullptr) {
                RPC::Administrator::Instance().Release(parameter_85ee3dc9Proxy, message->Response());
            }
        },
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_85ee3dc9) override
        {
            IPCMessage message(BaseClass::Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_85ee3dc9));
