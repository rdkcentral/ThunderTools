...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstance49D3F52C interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance49D3F52CStubMethods[] = {
        // (0) virtual bool Next(Exchange::IWifiControl::SecurityInfo&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstance49D3F52CStubMethods

    //
    // RPC::IIteratorTypeInstance8F542C9B interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance8F542C9BStubMethods[] = {
        // (0) virtual bool Next(Exchange::IWifiControl::NetworkInfo&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstance8F542C9BStubMethods

    //
    // RPC::IIteratorTypeInstance1E3FFC02 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance1E3FFC02StubMethods[] = {
        // (0) virtual bool Next(string&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstance1E3FFC02StubMethods
    ...
    //
    // RPC::IIteratorTypeInstance49D3F52C interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IWifiControl::SecurityInfo&) = 0
    //  (1) virtual bool Previous(Exchange::IWifiControl::SecurityInfo&) = 0
    ...
    class RPCIteratorTypeInstance49D3F52CProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IWifiControl::SecurityInfo, Exchange::ID_WIFICONTROL_SECURITY_INFO_ITERATOR>> {
    public:
        RPCIteratorTypeInstance49D3F52CProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstance49D3F52CProxy

    //
    // RPC::IIteratorTypeInstance8F542C9B interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IWifiControl::NetworkInfo&) = 0
    //  (1) virtual bool Previous(Exchange::IWifiControl::NetworkInfo&) = 0
    ...
    class RPCIteratorTypeInstance8F542C9BProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IWifiControl::NetworkInfo, Exchange::ID_WIFICONTROL_NETWORK_INFO_ITERATOR>> {
    public:
        RPCIteratorTypeInstance8F542C9BProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstance8F542C9BProxy

    //
    // RPC::IIteratorTypeInstance1E3FFC02 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(string&) = 0
    //  (1) virtual bool Previous(string&) = 0
    ...
    class RPCIteratorTypeInstance1E3FFC02Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>> {
    public:
        RPCIteratorTypeInstance1E3FFC02Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstance1E3FFC02Proxy
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IWifiControl::SecurityInfo, Exchange::ID_WIFICONTROL_SECURITY_INFO_ITERATOR>, RPCIteratorTypeInstance49D3F52CStubMethods> RPCIteratorTypeInstance49D3F52CStub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IWifiControl::NetworkInfo, Exchange::ID_WIFICONTROL_NETWORK_INFO_ITERATOR>, RPCIteratorTypeInstance8F542C9BStubMethods> RPCIteratorTypeInstance8F542C9BStub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstance1E3FFC02StubMethods> RPCIteratorTypeInstance1E3FFC02Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IWifiControl::SecurityInfo, Exchange::ID_WIFICONTROL_SECURITY_INFO_ITERATOR>, RPCIteratorTypeInstance49D3F52CProxy, RPCIteratorTypeInstance49D3F52CStub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IWifiControl::NetworkInfo, Exchange::ID_WIFICONTROL_NETWORK_INFO_ITERATOR>, RPCIteratorTypeInstance8F542C9BProxy, RPCIteratorTypeInstance8F542C9BStub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<string, RPC::ID_STRINGITERATOR>, RPCIteratorTypeInstance1E3FFC02Proxy, RPCIteratorTypeInstance1E3FFC02Stub>();
