...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangeApplicationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Exchange::IApplication::launchpointtype _parameter_4d894e28 = reader.Number<Exchange::IApplication::launchpointtype>();

            uint32_t result = implementation->LaunchPoint(static_cast<const Exchange::IApplication::launchpointtype&>(_parameter_4d894e28));
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const bool _parameter_d3a2a688 = reader.Boolean();

            uint32_t result = implementation->Visible(static_cast<const bool&>(_parameter_d3a2a688));
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_a662ca6e = reader.Text();

            uint32_t result = implementation->Language(static_cast<const string&>(_parameter_a662ca6e));
    ...
    public:
        ...
        uint32_t LaunchPoint(const Exchange::IApplication::launchpointtype& _parameter_4d894e28) override
        {
            IPCMessage message(BaseClass::Message(6));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Exchange::IApplication::launchpointtype>(static_cast<const Exchange::IApplication::launchpointtype&>(_parameter_4d894e28));
        ...
        uint32_t Visible(const bool& _parameter_d3a2a688) override
        {
            IPCMessage message(BaseClass::Message(8));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Boolean(static_cast<const bool&>(_parameter_d3a2a688));
        ...
        uint32_t Language(const string& _parameter_a662ca6e) override
        {
            IPCMessage message(BaseClass::Message(10));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(static_cast<const string&>(_parameter_a662ca6e));
