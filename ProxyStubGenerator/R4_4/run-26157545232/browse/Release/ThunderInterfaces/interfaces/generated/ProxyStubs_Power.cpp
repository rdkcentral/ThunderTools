...
namespace ProxyStubs {
    ...
    ProxyStub::MethodHandler ExchangePowerStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Exchange::IPower::PCState _parameter_fc0fe9d4 = reader.Number<Exchange::IPower::PCState>();
            const uint32_t _parameter_55fb8c49 = reader.Number<uint32_t>();

            uint32_t result = implementation->SetState(_parameter_fc0fe9d4, _parameter_55fb8c49);
    ...
    public:
        ...
        uint32_t SetState(const Exchange::IPower::PCState _parameter_fc0fe9d4, const uint32_t _parameter_55fb8c49) override
        {
            IPCMessage message(BaseClass::Message(3));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Exchange::IPower::PCState>(_parameter_fc0fe9d4);
            writer.Number<uint32_t>(_parameter_55fb8c49);
