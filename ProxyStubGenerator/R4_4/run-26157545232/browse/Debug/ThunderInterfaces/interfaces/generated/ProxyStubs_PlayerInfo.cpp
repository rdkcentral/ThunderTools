...
namespace ProxyStubs {
    ...
    //
    // RPC::IIteratorTypeInstance75AEB6BB interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstance75AEB6BBStubMethods[] = {
        // (0) virtual bool Next(Exchange::IPlayerProperties::AudioCodec&) = 0
        //
        ...
        , nullptr
    }; // RPCIteratorTypeInstance75AEB6BBStubMethods

    //
    // RPC::IIteratorTypeInstanceD46C50D5 interface stub definitions
    //
    // Methods:
    ...
    ProxyStub::MethodHandler RPCIteratorTypeInstanceD46C50D5StubMethods[] = {
        // (0) virtual bool Next(Exchange::IPlayerProperties::VideoCodec&) = 0
        //
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
        ...
        , nullptr
    }; // RPCIteratorTypeInstanceD46C50D5StubMethods
    ...
    //
    // RPC::IIteratorTypeInstance75AEB6BB interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IPlayerProperties::AudioCodec&) = 0
    //  (1) virtual bool Previous(Exchange::IPlayerProperties::AudioCodec&) = 0
    ...
    class RPCIteratorTypeInstance75AEB6BBProxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPlayerProperties::AudioCodec, Exchange::ID_PLAYER_PROPERTIES_AUDIO>> {
    public:
        RPCIteratorTypeInstance75AEB6BBProxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
    ...
    }; // class RPCIteratorTypeInstance75AEB6BBProxy

    //
    // RPC::IIteratorTypeInstanceD46C50D5 interface proxy definitions
    //
    // Methods:
    //  (0) virtual bool Next(Exchange::IPlayerProperties::VideoCodec&) = 0
    //  (1) virtual bool Previous(Exchange::IPlayerProperties::VideoCodec&) = 0
    ...
    class RPCIteratorTypeInstanceD46C50D5Proxy final : public ProxyStub::UnknownProxyType<RPC::IIteratorType<Exchange::IPlayerProperties::VideoCodec, Exchange::ID_PLAYER_PROPERTIES_VIDEO>> {
    public:
        RPCIteratorTypeInstanceD46C50D5Proxy(const Core::ProxyType<Core::IPCChannel>& channel, const Core::instance_id implementation, const bool otherSideInformed)
            : BaseClass(channel, implementation, otherSideInformed)
        {
        }
    ...
    }; // class RPCIteratorTypeInstanceD46C50D5Proxy
    ...
    namespace {
        ...
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IPlayerProperties::AudioCodec, Exchange::ID_PLAYER_PROPERTIES_AUDIO>, RPCIteratorTypeInstance75AEB6BBStubMethods> RPCIteratorTypeInstance75AEB6BBStub;
        typedef ProxyStub::UnknownStubType<RPC::IIteratorType<Exchange::IPlayerProperties::VideoCodec, Exchange::ID_PLAYER_PROPERTIES_VIDEO>, RPCIteratorTypeInstanceD46C50D5StubMethods> RPCIteratorTypeInstanceD46C50D5Stub;
        ...
        public:
            Instantiation()
            {
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IPlayerProperties::AudioCodec, Exchange::ID_PLAYER_PROPERTIES_AUDIO>, RPCIteratorTypeInstance75AEB6BBProxy, RPCIteratorTypeInstance75AEB6BBStub>();
                RPC::Administrator::Instance().Announce<RPC::IIteratorType<Exchange::IPlayerProperties::VideoCodec, Exchange::ID_PLAYER_PROPERTIES_VIDEO>, RPCIteratorTypeInstanceD46C50D5Proxy, RPCIteratorTypeInstanceD46C50D5Stub>();
