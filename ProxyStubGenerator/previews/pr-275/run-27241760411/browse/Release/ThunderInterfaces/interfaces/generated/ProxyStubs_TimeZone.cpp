...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeTimeZoneStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                if (RPC::Administrator::Instance().IsValid(channel, RPC::instance_cast(implementation), Exchange::ITimeZone::ID) == false) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
            ...
            if (hresult != Core::ERROR_NONE) {
                ...
                fprintf(stderr, "COM-RPC stub 0x%08x(%u) failed: 0x%08x\n", Exchange::ITimeZone::ID, 0, hresult);
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            if (hresult != Core::ERROR_NONE) {
                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(hresult);
                fprintf(stderr, "COM-RPC stub 0x%08x(%u) failed: 0x%08x\n", Exchange::ITimeZone::ID, 1, hresult);
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            if (hresult != Core::ERROR_NONE) {
                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(hresult);
                fprintf(stderr, "COM-RPC stub 0x%08x(%u) failed: 0x%08x\n", Exchange::ITimeZone::ID, 2, hresult);
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                const uint16_t _timeZonePeekedLen__ = reader.PeekNumber<uint16_t>();
                if (reader.Length() < (static_cast<uint32_t>(Core::RealSize<uint16_t>()) + _timeZonePeekedLen__)) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
            ...
            if (hresult != Core::ERROR_NONE) {
                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(hresult);
                fprintf(stderr, "COM-RPC stub 0x%08x(%u) failed: 0x%08x\n", Exchange::ITimeZone::ID, 3, hresult);
            }
        }
        , nullptr
    ...
    static ProxyStub::MethodHandler ExchangeTimeZoneNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                ASSERT(implementation != nullptr);
                if (RPC::Administrator::Instance().IsValid(channel, RPC::instance_cast(implementation), Exchange::ITimeZone::INotification::ID) == false) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
            ...
            if (hresult != Core::ERROR_NONE) {
                fprintf(stderr, "COM-RPC stub 0x%08x(%u) failed: 0x%08x\n", Exchange::ITimeZone::INotification::ID, 0, hresult);
    ...
    public:
        ...
        uint32_t Register(Exchange::ITimeZone::INotification* _sink) override
        {
            ...
            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_sink), Exchange::ITimeZone::INotification::ID }, { 0, 0 } };
    ...
    namespace {
        ...
        public:
            Instantiation()
            {
                ...
                RPC::Administrator::Instance().Announce<Exchange::ITimeZone, ExchangeTimeZoneProxy, ExchangeTimeZoneStub>(security);
                RPC::Administrator::Instance().Announce<Exchange::ITimeZone::INotification, ExchangeTimeZoneNotificationProxy, ExchangeTimeZoneNotificationStub>(security);
            }
            ~Instantiation()
            {
