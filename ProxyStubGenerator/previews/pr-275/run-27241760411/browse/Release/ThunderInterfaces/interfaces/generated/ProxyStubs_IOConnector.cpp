...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeIOConnectorStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                if (RPC::Administrator::Instance().IsValid(channel, RPC::instance_cast(implementation), Exchange::IIOConnector::ID) == false) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
            ...
            if (hresult != Core::ERROR_NONE) {
                ...
                fprintf(stderr, "COM-RPC stub 0x%08x(%u) failed: 0x%08x\n", Exchange::IIOConnector::ID, 0, hresult);
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            if (hresult != Core::ERROR_NONE) {
                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(hresult);
                fprintf(stderr, "COM-RPC stub 0x%08x(%u) failed: 0x%08x\n", Exchange::IIOConnector::ID, 1, hresult);
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            if (hresult != Core::ERROR_NONE) {
                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(hresult);
                fprintf(stderr, "COM-RPC stub 0x%08x(%u) failed: 0x%08x\n", Exchange::IIOConnector::ID, 2, hresult);
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            if (hresult != Core::ERROR_NONE) {
                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(hresult);
                fprintf(stderr, "COM-RPC stub 0x%08x(%u) failed: 0x%08x\n", Exchange::IIOConnector::ID, 3, hresult);
            }
        }
        , nullptr
    ...
    static ProxyStub::MethodHandler ExchangeIOConnectorNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                ASSERT(implementation != nullptr);
                if (RPC::Administrator::Instance().IsValid(channel, RPC::instance_cast(implementation), Exchange::IIOConnector::INotification::ID) == false) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
            ...
            if (hresult != Core::ERROR_NONE) {
                fprintf(stderr, "COM-RPC stub 0x%08x(%u) failed: 0x%08x\n", Exchange::IIOConnector::INotification::ID, 0, hresult);
    ...
    public:
        ...
        Core::hresult Register(const uint16_t _id, Exchange::IIOConnector::INotification* const _notification) override
        {
            ...
            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_notification), Exchange::IIOConnector::INotification::ID }, { 0, 0 } };
    ...
    namespace {
        ...
        public:
            Instantiation()
            {
                ...
                RPC::Administrator::Instance().Announce<Exchange::IIOConnector, ExchangeIOConnectorProxy, ExchangeIOConnectorStub>(security);
                RPC::Administrator::Instance().Announce<Exchange::IIOConnector::INotification, ExchangeIOConnectorNotificationProxy, ExchangeIOConnectorNotificationStub>(security);
            }
            ~Instantiation()
            {
