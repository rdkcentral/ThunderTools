...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeApplicationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const Exchange::IApplication::launchpointtype _parameter_4d2897c3 = reader.Number<Exchange::IApplication::launchpointtype>();

            uint32_t result = implementation->LaunchPoint(static_cast<const Exchange::IApplication::launchpointtype&>(_parameter_4d2897c3));
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const bool _parameter_291f61a6 = reader.Boolean();

            uint32_t result = implementation->Visible(_parameter_291f61a6);
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_866ec9fa = reader.Text();

            uint32_t result = implementation->Language(static_cast<const string&>(_parameter_866ec9fa));
    ...
    public:
        ...
        uint32_t LaunchPoint(const Exchange::IApplication::launchpointtype& _parameter_4d2897c3) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(6));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Exchange::IApplication::launchpointtype>(_parameter_4d2897c3);
        ...
        uint32_t Visible(const bool _parameter_291f61a6) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(8));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Boolean(_parameter_291f61a6);
        ...
        uint32_t Language(const string& _parameter_866ec9fa) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(10));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_866ec9fa);
