...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_378933d4InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_378933d4{};
            ProxyStub::UnknownProxy* _parameter_378933d4Proxy__ = nullptr;
            if (_parameter_378933d4InstanceId__ != 0) {
                _parameter_378933d4Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_378933d4InstanceId__, false, _parameter_378933d4);
                ASSERT((_parameter_378933d4 != nullptr) && (_parameter_378933d4Proxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_378933d4);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_378933d4Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_378933d4Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_dc7587d4InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_dc7587d4{};
            ProxyStub::UnknownProxy* _parameter_dc7587d4Proxy__ = nullptr;
            if (_parameter_dc7587d4InstanceId__ != 0) {
                _parameter_dc7587d4Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_dc7587d4InstanceId__, false, _parameter_dc7587d4);
                ASSERT((_parameter_dc7587d4 != nullptr) && (_parameter_dc7587d4Proxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_dc7587d4);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_dc7587d4Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_dc7587d4Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_378933d4) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_378933d4));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_dc7587d4) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_dc7587d4));
