...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_cebae23fInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_cebae23f{};
            ProxyStub::UnknownProxy* _parameter_cebae23fProxy__ = nullptr;
            if (_parameter_cebae23fInstanceId__ != 0) {
                _parameter_cebae23fProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_cebae23fInstanceId__, false, _parameter_cebae23f);
                ASSERT((_parameter_cebae23f != nullptr) && (_parameter_cebae23fProxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_cebae23f);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_cebae23fProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_cebae23fProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_08b2a492InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_08b2a492{};
            ProxyStub::UnknownProxy* _parameter_08b2a492Proxy__ = nullptr;
            if (_parameter_08b2a492InstanceId__ != 0) {
                _parameter_08b2a492Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_08b2a492InstanceId__, false, _parameter_08b2a492);
                ASSERT((_parameter_08b2a492 != nullptr) && (_parameter_08b2a492Proxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_08b2a492);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_08b2a492Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_08b2a492Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_cebae23f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_cebae23f));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_08b2a492) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_08b2a492));
