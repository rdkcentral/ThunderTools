...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_7dca2f56InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_7dca2f56{};
            ProxyStub::UnknownProxy* _parameter_7dca2f56Proxy__ = nullptr;
            if (_parameter_7dca2f56InstanceId__ != 0) {
                _parameter_7dca2f56Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_7dca2f56InstanceId__, false, _parameter_7dca2f56);
                ASSERT((_parameter_7dca2f56 != nullptr) && (_parameter_7dca2f56Proxy__ != nullptr));
            }

            uint32_t result = implementation->Initialize(_parameter_7dca2f56);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_7dca2f56Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_7dca2f56Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_2a9c6691InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_2a9c6691{};
            ProxyStub::UnknownProxy* _parameter_2a9c6691Proxy__ = nullptr;
            if (_parameter_2a9c6691InstanceId__ != 0) {
                _parameter_2a9c6691Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_2a9c6691InstanceId__, false, _parameter_2a9c6691);
                ASSERT((_parameter_2a9c6691 != nullptr) && (_parameter_2a9c6691Proxy__ != nullptr));
            }

            implementation->Deinitialize(_parameter_2a9c6691);

            if (_parameter_2a9c6691Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_2a9c6691Proxy__, message->Response());
            }
        },
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_5fce6898InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_5fce6898{};
            ProxyStub::UnknownProxy* _parameter_5fce6898Proxy__ = nullptr;
            if (_parameter_5fce6898InstanceId__ != 0) {
                _parameter_5fce6898Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_5fce6898InstanceId__, false, _parameter_5fce6898);
                ASSERT((_parameter_5fce6898 != nullptr) && (_parameter_5fce6898Proxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_5fce6898);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_5fce6898Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_5fce6898Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_7dca2f56) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_7dca2f56));
        ...
        void Deinitialize(PluginHost::IShell* _parameter_2a9c6691) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_2a9c6691));
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_5fce6898) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_5fce6898));
