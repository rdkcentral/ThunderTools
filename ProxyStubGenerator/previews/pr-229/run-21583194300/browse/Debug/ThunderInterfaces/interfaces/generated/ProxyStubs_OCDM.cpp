...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeSessionStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_71c196c1 = reader.Text();
            const string _parameter_eeb37ed2 = reader.Text();

            Exchange::OCDM_RESULT result = implementation->SetParameter(static_cast<const string&>(_parameter_71c196c1), static_cast<const string&>(_parameter_eeb37ed2));
    ...
    public:
        ...
        Exchange::OCDM_RESULT SetParameter(const string& _parameter_71c196c1, const string& _parameter_eeb37ed2) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(13));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_71c196c1);
            writer.Text(_parameter_eeb37ed2);
