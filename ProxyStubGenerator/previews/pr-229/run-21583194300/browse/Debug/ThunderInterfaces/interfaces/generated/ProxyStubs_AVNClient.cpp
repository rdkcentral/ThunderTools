...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeAVNClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_04602382InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_04602382{};
            ProxyStub::UnknownProxy* _parameter_04602382Proxy__ = nullptr;
            if (_parameter_04602382InstanceId__ != 0) {
                _parameter_04602382Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_04602382InstanceId__, false, _parameter_04602382);
                ASSERT((_parameter_04602382 != nullptr) && (_parameter_04602382Proxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_04602382);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_04602382Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_04602382Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_debe8a4f = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_debe8a4f));
        }
        , nullptr
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_04602382) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_04602382));
        ...
        void Launch(const string& _parameter_debe8a4f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_debe8a4f);
