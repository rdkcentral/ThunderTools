...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_0cd2cb33 = reader.Text();
            const string _parameter_27b41643 = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_0cd2cb33), static_cast<const string&>(_parameter_27b41643));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_0cd2cb33, const string& _parameter_27b41643) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_0cd2cb33);
            writer.Text(_parameter_27b41643);
