...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_3205c2dbInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IStream::ICallback* _parameter_3205c2db{};
            ProxyStub::UnknownProxy* _parameter_3205c2dbProxy__ = nullptr;
            if (_parameter_3205c2dbInstanceId__ != 0) {
                _parameter_3205c2dbProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_3205c2dbInstanceId__, false, _parameter_3205c2db);
                ASSERT((_parameter_3205c2db != nullptr) && (_parameter_3205c2dbProxy__ != nullptr));
            }

            implementation->Callback(_parameter_3205c2db);

            if (_parameter_3205c2dbProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_3205c2dbProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_3205c2db) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_3205c2db));
