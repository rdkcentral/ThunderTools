...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_643f3e06InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_643f3e06{};
            ProxyStub::UnknownProxy* _parameter_643f3e06Proxy__ = nullptr;
            if (_parameter_643f3e06InstanceId__ != 0) {
                _parameter_643f3e06Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_643f3e06InstanceId__, false, _parameter_643f3e06);
                ASSERT((_parameter_643f3e06 != nullptr) && (_parameter_643f3e06Proxy__ != nullptr));
            }

            implementation->Activated(_parameter_643f3e06);

            if (_parameter_643f3e06Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_643f3e06Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_8f6546b2InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_8f6546b2{};
            ProxyStub::UnknownProxy* _parameter_8f6546b2Proxy__ = nullptr;
            if (_parameter_8f6546b2InstanceId__ != 0) {
                _parameter_8f6546b2Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_8f6546b2InstanceId__, false, _parameter_8f6546b2);
                ASSERT((_parameter_8f6546b2 != nullptr) && (_parameter_8f6546b2Proxy__ != nullptr));
            }

            implementation->Deactivated(_parameter_8f6546b2);

            if (_parameter_8f6546b2Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_8f6546b2Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_7cb4550aInstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_7cb4550a{};
            ProxyStub::UnknownProxy* _parameter_7cb4550aProxy__ = nullptr;
            if (_parameter_7cb4550aInstanceId__ != 0) {
                _parameter_7cb4550aProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_7cb4550aInstanceId__, false, _parameter_7cb4550a);
                ASSERT((_parameter_7cb4550a != nullptr) && (_parameter_7cb4550aProxy__ != nullptr));
            }

            implementation->Terminated(_parameter_7cb4550a);

            if (_parameter_7cb4550aProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_7cb4550aProxy__, message->Response());
            }
        }
        , nullptr
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_643f3e06) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_643f3e06));
        ...
        void Deactivated(IRemoteConnection* _parameter_8f6546b2) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_8f6546b2));
        ...
        void Terminated(IRemoteConnection* _parameter_7cb4550a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_7cb4550a));
