...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_c10ba73aInstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_c10ba73a{};
                ProxyStub::UnknownProxy* _parameter_c10ba73aProxy__ = nullptr;
                if (_parameter_c10ba73aInstanceId__ != 0) {
                    _parameter_c10ba73aProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_c10ba73aInstanceId__, false, _parameter_c10ba73a);
                    ASSERT((_parameter_c10ba73a != nullptr) && (_parameter_c10ba73aProxy__ != nullptr));
                    if ((_parameter_c10ba73a == nullptr) || (_parameter_c10ba73aProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Activated(_parameter_c10ba73a);

                if (_parameter_c10ba73aProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_c10ba73aProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_40dc0b1bInstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_40dc0b1b{};
                ProxyStub::UnknownProxy* _parameter_40dc0b1bProxy__ = nullptr;
                if (_parameter_40dc0b1bInstanceId__ != 0) {
                    _parameter_40dc0b1bProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_40dc0b1bInstanceId__, false, _parameter_40dc0b1b);
                    ASSERT((_parameter_40dc0b1b != nullptr) && (_parameter_40dc0b1bProxy__ != nullptr));
                    if ((_parameter_40dc0b1b == nullptr) || (_parameter_40dc0b1bProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deactivated(_parameter_40dc0b1b);

                if (_parameter_40dc0b1bProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_40dc0b1bProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_53aee37bInstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_53aee37b{};
                ProxyStub::UnknownProxy* _parameter_53aee37bProxy__ = nullptr;
                if (_parameter_53aee37bInstanceId__ != 0) {
                    _parameter_53aee37bProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_53aee37bInstanceId__, false, _parameter_53aee37b);
                    ASSERT((_parameter_53aee37b != nullptr) && (_parameter_53aee37bProxy__ != nullptr));
                    if ((_parameter_53aee37b == nullptr) || (_parameter_53aee37bProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Terminated(_parameter_53aee37b);

                if (_parameter_53aee37bProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_53aee37bProxy__, message->Response());
                }
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_c10ba73a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_c10ba73a));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_c10ba73a), IRemoteConnection::ID }, { 0, 0 } };
        ...
        void Deactivated(IRemoteConnection* _parameter_40dc0b1b) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_40dc0b1b));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_40dc0b1b), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
        ...
        void Terminated(IRemoteConnection* _parameter_53aee37b) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_53aee37b));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_53aee37b), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
