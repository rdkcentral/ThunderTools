...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_4cada00aInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_4cada00a{};
                ProxyStub::UnknownProxy* _parameter_4cada00aProxy__ = nullptr;
                if (_parameter_4cada00aInstanceId__ != 0) {
                    _parameter_4cada00aProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_4cada00aInstanceId__, false, _parameter_4cada00a);
                    ASSERT((_parameter_4cada00a != nullptr) && (_parameter_4cada00aProxy__ != nullptr));
                    if ((_parameter_4cada00a == nullptr) || (_parameter_4cada00aProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_4cada00a);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_4cada00aProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_4cada00aProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_8104ee88InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_8104ee88{};
                ProxyStub::UnknownProxy* _parameter_8104ee88Proxy__ = nullptr;
                if (_parameter_8104ee88InstanceId__ != 0) {
                    _parameter_8104ee88Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_8104ee88InstanceId__, false, _parameter_8104ee88);
                    ASSERT((_parameter_8104ee88 != nullptr) && (_parameter_8104ee88Proxy__ != nullptr));
                    if ((_parameter_8104ee88 == nullptr) || (_parameter_8104ee88Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_8104ee88);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_8104ee88Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_8104ee88Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_4cada00a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_4cada00a));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_4cada00a), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_8104ee88) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_8104ee88));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_8104ee88), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
