...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_905f5dc1InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IStream::ICallback* _parameter_905f5dc1{};
                ProxyStub::UnknownProxy* _parameter_905f5dc1Proxy__ = nullptr;
                if (_parameter_905f5dc1InstanceId__ != 0) {
                    _parameter_905f5dc1Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_905f5dc1InstanceId__, false, _parameter_905f5dc1);
                    ASSERT((_parameter_905f5dc1 != nullptr) && (_parameter_905f5dc1Proxy__ != nullptr));
                    if ((_parameter_905f5dc1 == nullptr) || (_parameter_905f5dc1Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Callback(_parameter_905f5dc1);

                if (_parameter_905f5dc1Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_905f5dc1Proxy__, message->Response());
                }
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_905f5dc1) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_905f5dc1));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_905f5dc1), Exchange::IStream::ICallback::ID }, { 0, 0 } };
