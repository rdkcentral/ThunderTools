...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_32816d91InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_32816d91{};
                ProxyStub::UnknownProxy* _parameter_32816d91Proxy__ = nullptr;
                if (_parameter_32816d91InstanceId__ != 0) {
                    _parameter_32816d91Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_32816d91InstanceId__, false, _parameter_32816d91);
                    ASSERT((_parameter_32816d91 != nullptr) && (_parameter_32816d91Proxy__ != nullptr));
                    if ((_parameter_32816d91 == nullptr) || (_parameter_32816d91Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Initialize(_parameter_32816d91);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_32816d91Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_32816d91Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_0700e32fInstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_0700e32f{};
                ProxyStub::UnknownProxy* _parameter_0700e32fProxy__ = nullptr;
                if (_parameter_0700e32fInstanceId__ != 0) {
                    _parameter_0700e32fProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_0700e32fInstanceId__, false, _parameter_0700e32f);
                    ASSERT((_parameter_0700e32f != nullptr) && (_parameter_0700e32fProxy__ != nullptr));
                    if ((_parameter_0700e32f == nullptr) || (_parameter_0700e32fProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deinitialize(_parameter_0700e32f);

                if (_parameter_0700e32fProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_0700e32fProxy__, message->Response());
                }
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_48ec7cc9InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_48ec7cc9{};
                ProxyStub::UnknownProxy* _parameter_48ec7cc9Proxy__ = nullptr;
                if (_parameter_48ec7cc9InstanceId__ != 0) {
                    _parameter_48ec7cc9Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_48ec7cc9InstanceId__, false, _parameter_48ec7cc9);
                    ASSERT((_parameter_48ec7cc9 != nullptr) && (_parameter_48ec7cc9Proxy__ != nullptr));
                    if ((_parameter_48ec7cc9 == nullptr) || (_parameter_48ec7cc9Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Configure(_parameter_48ec7cc9);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_48ec7cc9Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_48ec7cc9Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_32816d91) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_32816d91));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_32816d91), PluginHost::IShell::ID }, { 0, 0 } };
        ...
        void Deinitialize(PluginHost::IShell* _parameter_0700e32f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_0700e32f));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_0700e32f), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_48ec7cc9) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_48ec7cc9));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_48ec7cc9), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
