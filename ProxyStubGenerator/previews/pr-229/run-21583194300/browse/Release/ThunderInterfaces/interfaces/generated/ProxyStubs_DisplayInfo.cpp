...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_cd6fb4a9InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_cd6fb4a9{};
                ProxyStub::UnknownProxy* _parameter_cd6fb4a9Proxy__ = nullptr;
                if (_parameter_cd6fb4a9InstanceId__ != 0) {
                    _parameter_cd6fb4a9Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_cd6fb4a9InstanceId__, false, _parameter_cd6fb4a9);
                    ASSERT((_parameter_cd6fb4a9 != nullptr) && (_parameter_cd6fb4a9Proxy__ != nullptr));
                    if ((_parameter_cd6fb4a9 == nullptr) || (_parameter_cd6fb4a9Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_cd6fb4a9);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_cd6fb4a9Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_cd6fb4a9Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_2226330eInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_2226330e{};
                ProxyStub::UnknownProxy* _parameter_2226330eProxy__ = nullptr;
                if (_parameter_2226330eInstanceId__ != 0) {
                    _parameter_2226330eProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_2226330eInstanceId__, false, _parameter_2226330e);
                    ASSERT((_parameter_2226330e != nullptr) && (_parameter_2226330eProxy__ != nullptr));
                    if ((_parameter_2226330e == nullptr) || (_parameter_2226330eProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_2226330e);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_2226330eProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_2226330eProxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_cd6fb4a9) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_cd6fb4a9));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_cd6fb4a9), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_2226330e) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_2226330e));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_2226330e), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
