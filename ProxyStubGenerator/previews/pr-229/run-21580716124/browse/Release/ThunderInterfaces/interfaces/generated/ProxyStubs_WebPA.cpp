...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_b0322dcbInstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_b0322dcb{};
                ProxyStub::UnknownProxy* _parameter_b0322dcbProxy__ = nullptr;
                if (_parameter_b0322dcbInstanceId__ != 0) {
                    _parameter_b0322dcbProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_b0322dcbInstanceId__, false, _parameter_b0322dcb);
                    ASSERT((_parameter_b0322dcb != nullptr) && (_parameter_b0322dcbProxy__ != nullptr));
                    if ((_parameter_b0322dcb == nullptr) || (_parameter_b0322dcbProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Initialize(_parameter_b0322dcb);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_b0322dcbProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_b0322dcbProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_c84ee1d6InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_c84ee1d6{};
                ProxyStub::UnknownProxy* _parameter_c84ee1d6Proxy__ = nullptr;
                if (_parameter_c84ee1d6InstanceId__ != 0) {
                    _parameter_c84ee1d6Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_c84ee1d6InstanceId__, false, _parameter_c84ee1d6);
                    ASSERT((_parameter_c84ee1d6 != nullptr) && (_parameter_c84ee1d6Proxy__ != nullptr));
                    if ((_parameter_c84ee1d6 == nullptr) || (_parameter_c84ee1d6Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deinitialize(_parameter_c84ee1d6);

                if (_parameter_c84ee1d6Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_c84ee1d6Proxy__, message->Response());
                }
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_2eeccac6InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_2eeccac6{};
                ProxyStub::UnknownProxy* _parameter_2eeccac6Proxy__ = nullptr;
                if (_parameter_2eeccac6InstanceId__ != 0) {
                    _parameter_2eeccac6Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_2eeccac6InstanceId__, false, _parameter_2eeccac6);
                    ASSERT((_parameter_2eeccac6 != nullptr) && (_parameter_2eeccac6Proxy__ != nullptr));
                    if ((_parameter_2eeccac6 == nullptr) || (_parameter_2eeccac6Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Configure(_parameter_2eeccac6);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_2eeccac6Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_2eeccac6Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_b0322dcb) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_b0322dcb));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_b0322dcb), PluginHost::IShell::ID }, { 0, 0 } };
        ...
        void Deinitialize(PluginHost::IShell* _parameter_c84ee1d6) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_c84ee1d6));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_c84ee1d6), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_2eeccac6) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_2eeccac6));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_2eeccac6), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
