...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_fd9821b7InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_fd9821b7{};
                ProxyStub::UnknownProxy* _parameter_fd9821b7Proxy__ = nullptr;
                if (_parameter_fd9821b7InstanceId__ != 0) {
                    _parameter_fd9821b7Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_fd9821b7InstanceId__, false, _parameter_fd9821b7);
                    ASSERT((_parameter_fd9821b7 != nullptr) && (_parameter_fd9821b7Proxy__ != nullptr));
                    if ((_parameter_fd9821b7 == nullptr) || (_parameter_fd9821b7Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_fd9821b7);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_fd9821b7Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_fd9821b7Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_fc0b502cInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_fc0b502c{};
                ProxyStub::UnknownProxy* _parameter_fc0b502cProxy__ = nullptr;
                if (_parameter_fc0b502cInstanceId__ != 0) {
                    _parameter_fc0b502cProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_fc0b502cInstanceId__, false, _parameter_fc0b502c);
                    ASSERT((_parameter_fc0b502c != nullptr) && (_parameter_fc0b502cProxy__ != nullptr));
                    if ((_parameter_fc0b502c == nullptr) || (_parameter_fc0b502cProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_fc0b502c);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_fc0b502cProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_fc0b502cProxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_fd9821b7) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_fd9821b7));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_fd9821b7), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_fc0b502c) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_fc0b502c));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_fc0b502c), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
