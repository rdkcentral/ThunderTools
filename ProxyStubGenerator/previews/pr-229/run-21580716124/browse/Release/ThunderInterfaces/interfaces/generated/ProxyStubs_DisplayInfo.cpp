...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_14c26942InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_14c26942{};
                ProxyStub::UnknownProxy* _parameter_14c26942Proxy__ = nullptr;
                if (_parameter_14c26942InstanceId__ != 0) {
                    _parameter_14c26942Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_14c26942InstanceId__, false, _parameter_14c26942);
                    ASSERT((_parameter_14c26942 != nullptr) && (_parameter_14c26942Proxy__ != nullptr));
                    if ((_parameter_14c26942 == nullptr) || (_parameter_14c26942Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_14c26942);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_14c26942Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_14c26942Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_425e4a52InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_425e4a52{};
                ProxyStub::UnknownProxy* _parameter_425e4a52Proxy__ = nullptr;
                if (_parameter_425e4a52InstanceId__ != 0) {
                    _parameter_425e4a52Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_425e4a52InstanceId__, false, _parameter_425e4a52);
                    ASSERT((_parameter_425e4a52 != nullptr) && (_parameter_425e4a52Proxy__ != nullptr));
                    if ((_parameter_425e4a52 == nullptr) || (_parameter_425e4a52Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_425e4a52);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_425e4a52Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_425e4a52Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_14c26942) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_14c26942));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_14c26942), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_425e4a52) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_425e4a52));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_425e4a52), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
