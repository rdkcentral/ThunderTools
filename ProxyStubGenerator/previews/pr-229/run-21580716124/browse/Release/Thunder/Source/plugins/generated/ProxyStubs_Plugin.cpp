...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler CompositPluginStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_822eabd7InstanceId__ = reader.Number<Core::instance_id>();

                ICompositPlugin::ICallback* _parameter_822eabd7{};
                ProxyStub::UnknownProxy* _parameter_822eabd7Proxy__ = nullptr;
                if (_parameter_822eabd7InstanceId__ != 0) {
                    _parameter_822eabd7Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_822eabd7InstanceId__, false, _parameter_822eabd7);
                    ASSERT((_parameter_822eabd7 != nullptr) && (_parameter_822eabd7Proxy__ != nullptr));
                    if ((_parameter_822eabd7 == nullptr) || (_parameter_822eabd7Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Callback(_parameter_822eabd7);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_822eabd7Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_822eabd7Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Callback(ICompositPlugin::ICallback* _parameter_822eabd7) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_822eabd7));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_822eabd7), ICompositPlugin::ICallback::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
