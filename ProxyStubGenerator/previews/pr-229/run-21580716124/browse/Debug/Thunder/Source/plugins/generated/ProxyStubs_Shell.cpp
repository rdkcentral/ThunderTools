...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ShellStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const IShell::reason _parameter_a4c27c03 = reader.Number<IShell::reason>();

            Core::hresult result = implementation->Activate(_parameter_a4c27c03);
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const IShell::reason _parameter_43032f62 = reader.Number<IShell::reason>();

            Core::hresult result = implementation->Deactivate(_parameter_43032f62);
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const IShell::reason _parameter_be04952a = reader.Number<IShell::reason>();

            Core::hresult result = implementation->Unavailable(_parameter_be04952a);
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_12ac8d26 = reader.Text();

            RPC::IStringIterator* result = implementation->GetLibrarySearchPaths(static_cast<const string&>(_parameter_12ac8d26));
    ...
    public:
        ...
        Core::hresult Activate(const IShell::reason _parameter_a4c27c03) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(32));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<IShell::reason>(_parameter_a4c27c03);
        ...
        Core::hresult Deactivate(const IShell::reason _parameter_43032f62) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(33));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<IShell::reason>(_parameter_43032f62);
        ...
        Core::hresult Unavailable(const IShell::reason _parameter_be04952a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(34));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<IShell::reason>(_parameter_be04952a);
        ...
        RPC::IStringIterator* GetLibrarySearchPaths(const string& _parameter_12ac8d26) const override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(38));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_12ac8d26);
