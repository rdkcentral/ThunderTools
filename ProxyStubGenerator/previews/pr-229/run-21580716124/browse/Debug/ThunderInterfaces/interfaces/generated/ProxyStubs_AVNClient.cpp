...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeAVNClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_5418ccaeInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_5418ccae{};
            ProxyStub::UnknownProxy* _parameter_5418ccaeProxy__ = nullptr;
            if (_parameter_5418ccaeInstanceId__ != 0) {
                _parameter_5418ccaeProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_5418ccaeInstanceId__, false, _parameter_5418ccae);
                ASSERT((_parameter_5418ccae != nullptr) && (_parameter_5418ccaeProxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_5418ccae);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_5418ccaeProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_5418ccaeProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_53af02f3 = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_53af02f3));
        }
        , nullptr
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_5418ccae) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_5418ccae));
        ...
        void Launch(const string& _parameter_53af02f3) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_53af02f3);
