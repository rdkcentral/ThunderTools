...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_50f01379 = reader.Text();
            const string _parameter_38081bdc = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_50f01379), static_cast<const string&>(_parameter_38081bdc));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_50f01379, const string& _parameter_38081bdc) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_50f01379);
            writer.Text(_parameter_38081bdc);
