...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeSessionStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_f59b5fce = reader.Text();
            const string _parameter_d7d21324 = reader.Text();

            Exchange::OCDM_RESULT result = implementation->SetParameter(static_cast<const string&>(_parameter_f59b5fce), static_cast<const string&>(_parameter_d7d21324));
    ...
    public:
        ...
        Exchange::OCDM_RESULT SetParameter(const string& _parameter_f59b5fce, const string& _parameter_d7d21324) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(13));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_f59b5fce);
            writer.Text(_parameter_d7d21324);
