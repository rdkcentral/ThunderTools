...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_bc76cc22InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_bc76cc22{};
            ProxyStub::UnknownProxy* _parameter_bc76cc22Proxy__ = nullptr;
            if (_parameter_bc76cc22InstanceId__ != 0) {
                _parameter_bc76cc22Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_bc76cc22InstanceId__, false, _parameter_bc76cc22);
                ASSERT((_parameter_bc76cc22 != nullptr) && (_parameter_bc76cc22Proxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_bc76cc22);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_bc76cc22Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_bc76cc22Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_4974510dInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_4974510d{};
            ProxyStub::UnknownProxy* _parameter_4974510dProxy__ = nullptr;
            if (_parameter_4974510dInstanceId__ != 0) {
                _parameter_4974510dProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_4974510dInstanceId__, false, _parameter_4974510d);
                ASSERT((_parameter_4974510d != nullptr) && (_parameter_4974510dProxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_4974510d);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_4974510dProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_4974510dProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_bc76cc22) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_bc76cc22));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_4974510d) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_4974510d));
