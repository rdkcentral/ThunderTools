...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_1af765cfInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IStream::ICallback* _parameter_1af765cf{};
            ProxyStub::UnknownProxy* _parameter_1af765cfProxy__ = nullptr;
            if (_parameter_1af765cfInstanceId__ != 0) {
                _parameter_1af765cfProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_1af765cfInstanceId__, false, _parameter_1af765cf);
                ASSERT((_parameter_1af765cf != nullptr) && (_parameter_1af765cfProxy__ != nullptr));
            }

            implementation->Callback(_parameter_1af765cf);

            if (_parameter_1af765cfProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_1af765cfProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_1af765cf) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_1af765cf));
