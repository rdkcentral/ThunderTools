...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_7659c9b3InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_7659c9b3{};
            ProxyStub::UnknownProxy* _parameter_7659c9b3Proxy__ = nullptr;
            if (_parameter_7659c9b3InstanceId__ != 0) {
                _parameter_7659c9b3Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_7659c9b3InstanceId__, false, _parameter_7659c9b3);
                ASSERT((_parameter_7659c9b3 != nullptr) && (_parameter_7659c9b3Proxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_7659c9b3);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_7659c9b3Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_7659c9b3Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_36a60e0eInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_36a60e0e{};
            ProxyStub::UnknownProxy* _parameter_36a60e0eProxy__ = nullptr;
            if (_parameter_36a60e0eInstanceId__ != 0) {
                _parameter_36a60e0eProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_36a60e0eInstanceId__, false, _parameter_36a60e0e);
                ASSERT((_parameter_36a60e0e != nullptr) && (_parameter_36a60e0eProxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_36a60e0e);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_36a60e0eProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_36a60e0eProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_7659c9b3) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_7659c9b3));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_36a60e0e) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_36a60e0e));
