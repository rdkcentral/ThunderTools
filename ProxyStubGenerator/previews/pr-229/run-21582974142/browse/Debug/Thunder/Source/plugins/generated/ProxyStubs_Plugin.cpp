...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler CompositPluginStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_8532e40bInstanceId__ = reader.Number<Core::instance_id>();

            ICompositPlugin::ICallback* _parameter_8532e40b{};
            ProxyStub::UnknownProxy* _parameter_8532e40bProxy__ = nullptr;
            if (_parameter_8532e40bInstanceId__ != 0) {
                _parameter_8532e40bProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_8532e40bInstanceId__, false, _parameter_8532e40b);
                ASSERT((_parameter_8532e40b != nullptr) && (_parameter_8532e40bProxy__ != nullptr));
            }

            uint32_t result = implementation->Callback(_parameter_8532e40b);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_8532e40bProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_8532e40bProxy__, message->Response());
            }
        }
        , nullptr
    ...
    public:
        ...
        uint32_t Callback(ICompositPlugin::ICallback* _parameter_8532e40b) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_8532e40b));
