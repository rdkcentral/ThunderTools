...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_e3b02f11InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_e3b02f11{};
            ProxyStub::UnknownProxy* _parameter_e3b02f11Proxy__ = nullptr;
            if (_parameter_e3b02f11InstanceId__ != 0) {
                _parameter_e3b02f11Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_e3b02f11InstanceId__, false, _parameter_e3b02f11);
                ASSERT((_parameter_e3b02f11 != nullptr) && (_parameter_e3b02f11Proxy__ != nullptr));
            }

            implementation->Activated(_parameter_e3b02f11);

            if (_parameter_e3b02f11Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_e3b02f11Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_ddf63db7InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_ddf63db7{};
            ProxyStub::UnknownProxy* _parameter_ddf63db7Proxy__ = nullptr;
            if (_parameter_ddf63db7InstanceId__ != 0) {
                _parameter_ddf63db7Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_ddf63db7InstanceId__, false, _parameter_ddf63db7);
                ASSERT((_parameter_ddf63db7 != nullptr) && (_parameter_ddf63db7Proxy__ != nullptr));
            }

            implementation->Deactivated(_parameter_ddf63db7);

            if (_parameter_ddf63db7Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_ddf63db7Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_2c16e1edInstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_2c16e1ed{};
            ProxyStub::UnknownProxy* _parameter_2c16e1edProxy__ = nullptr;
            if (_parameter_2c16e1edInstanceId__ != 0) {
                _parameter_2c16e1edProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_2c16e1edInstanceId__, false, _parameter_2c16e1ed);
                ASSERT((_parameter_2c16e1ed != nullptr) && (_parameter_2c16e1edProxy__ != nullptr));
            }

            implementation->Terminated(_parameter_2c16e1ed);

            if (_parameter_2c16e1edProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_2c16e1edProxy__, message->Response());
            }
        }
        , nullptr
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_e3b02f11) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_e3b02f11));
        ...
        void Deactivated(IRemoteConnection* _parameter_ddf63db7) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_ddf63db7));
        ...
        void Terminated(IRemoteConnection* _parameter_2c16e1ed) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_2c16e1ed));
