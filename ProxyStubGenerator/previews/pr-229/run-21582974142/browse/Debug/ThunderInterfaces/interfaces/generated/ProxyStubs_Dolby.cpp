...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_42b38860InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_42b38860{};
            ProxyStub::UnknownProxy* _parameter_42b38860Proxy__ = nullptr;
            if (_parameter_42b38860InstanceId__ != 0) {
                _parameter_42b38860Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_42b38860InstanceId__, false, _parameter_42b38860);
                ASSERT((_parameter_42b38860 != nullptr) && (_parameter_42b38860Proxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_42b38860);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_42b38860Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_42b38860Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_e6b5982fInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_e6b5982f{};
            ProxyStub::UnknownProxy* _parameter_e6b5982fProxy__ = nullptr;
            if (_parameter_e6b5982fInstanceId__ != 0) {
                _parameter_e6b5982fProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_e6b5982fInstanceId__, false, _parameter_e6b5982f);
                ASSERT((_parameter_e6b5982f != nullptr) && (_parameter_e6b5982fProxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_e6b5982f);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_e6b5982fProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_e6b5982fProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_42b38860) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_42b38860));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_e6b5982f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_e6b5982f));
