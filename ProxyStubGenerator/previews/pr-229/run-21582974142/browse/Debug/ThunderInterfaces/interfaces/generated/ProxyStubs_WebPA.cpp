...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_78332913InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_78332913{};
            ProxyStub::UnknownProxy* _parameter_78332913Proxy__ = nullptr;
            if (_parameter_78332913InstanceId__ != 0) {
                _parameter_78332913Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_78332913InstanceId__, false, _parameter_78332913);
                ASSERT((_parameter_78332913 != nullptr) && (_parameter_78332913Proxy__ != nullptr));
            }

            uint32_t result = implementation->Initialize(_parameter_78332913);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_78332913Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_78332913Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_fb331130InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_fb331130{};
            ProxyStub::UnknownProxy* _parameter_fb331130Proxy__ = nullptr;
            if (_parameter_fb331130InstanceId__ != 0) {
                _parameter_fb331130Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_fb331130InstanceId__, false, _parameter_fb331130);
                ASSERT((_parameter_fb331130 != nullptr) && (_parameter_fb331130Proxy__ != nullptr));
            }

            implementation->Deinitialize(_parameter_fb331130);

            if (_parameter_fb331130Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_fb331130Proxy__, message->Response());
            }
        },
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_4a75d13eInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_4a75d13e{};
            ProxyStub::UnknownProxy* _parameter_4a75d13eProxy__ = nullptr;
            if (_parameter_4a75d13eInstanceId__ != 0) {
                _parameter_4a75d13eProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_4a75d13eInstanceId__, false, _parameter_4a75d13e);
                ASSERT((_parameter_4a75d13e != nullptr) && (_parameter_4a75d13eProxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_4a75d13e);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_4a75d13eProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_4a75d13eProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_78332913) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_78332913));
        ...
        void Deinitialize(PluginHost::IShell* _parameter_fb331130) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_fb331130));
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_4a75d13e) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_4a75d13e));
