...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_3b0f0f23InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_3b0f0f23{};
            ProxyStub::UnknownProxy* _parameter_3b0f0f23Proxy__ = nullptr;
            if (_parameter_3b0f0f23InstanceId__ != 0) {
                _parameter_3b0f0f23Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_3b0f0f23InstanceId__, false, _parameter_3b0f0f23);
                ASSERT((_parameter_3b0f0f23 != nullptr) && (_parameter_3b0f0f23Proxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_3b0f0f23);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_3b0f0f23Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_3b0f0f23Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_22e05cebInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_22e05ceb{};
            ProxyStub::UnknownProxy* _parameter_22e05cebProxy__ = nullptr;
            if (_parameter_22e05cebInstanceId__ != 0) {
                _parameter_22e05cebProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_22e05cebInstanceId__, false, _parameter_22e05ceb);
                ASSERT((_parameter_22e05ceb != nullptr) && (_parameter_22e05cebProxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_22e05ceb);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_22e05cebProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_22e05cebProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_3b0f0f23) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_3b0f0f23));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_22e05ceb) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_22e05ceb));
