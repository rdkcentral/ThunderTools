...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeAVNClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_49141781InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_49141781{};
            ProxyStub::UnknownProxy* _parameter_49141781Proxy__ = nullptr;
            if (_parameter_49141781InstanceId__ != 0) {
                _parameter_49141781Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_49141781InstanceId__, false, _parameter_49141781);
                ASSERT((_parameter_49141781 != nullptr) && (_parameter_49141781Proxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_49141781);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_49141781Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_49141781Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_f52ea4ad = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_f52ea4ad));
        }
        , nullptr
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_49141781) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_49141781));
        ...
        void Launch(const string& _parameter_f52ea4ad) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_f52ea4ad);
