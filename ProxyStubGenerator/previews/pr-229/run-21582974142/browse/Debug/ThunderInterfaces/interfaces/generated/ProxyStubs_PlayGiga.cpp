...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_c893e20a = reader.Text();
            const string _parameter_538258cd = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_c893e20a), static_cast<const string&>(_parameter_538258cd));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_c893e20a, const string& _parameter_538258cd) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_c893e20a);
            writer.Text(_parameter_538258cd);
