...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeSessionStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_c78907f5 = reader.Text();
            const string _parameter_6435799b = reader.Text();

            Exchange::OCDM_RESULT result = implementation->SetParameter(static_cast<const string&>(_parameter_c78907f5), static_cast<const string&>(_parameter_6435799b));
    ...
    public:
        ...
        Exchange::OCDM_RESULT SetParameter(const string& _parameter_c78907f5, const string& _parameter_6435799b) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(13));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_c78907f5);
            writer.Text(_parameter_6435799b);
