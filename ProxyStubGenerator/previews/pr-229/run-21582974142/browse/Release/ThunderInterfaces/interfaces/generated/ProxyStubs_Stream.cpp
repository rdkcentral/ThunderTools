...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_e24a3fc7InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IStream::ICallback* _parameter_e24a3fc7{};
                ProxyStub::UnknownProxy* _parameter_e24a3fc7Proxy__ = nullptr;
                if (_parameter_e24a3fc7InstanceId__ != 0) {
                    _parameter_e24a3fc7Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_e24a3fc7InstanceId__, false, _parameter_e24a3fc7);
                    ASSERT((_parameter_e24a3fc7 != nullptr) && (_parameter_e24a3fc7Proxy__ != nullptr));
                    if ((_parameter_e24a3fc7 == nullptr) || (_parameter_e24a3fc7Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Callback(_parameter_e24a3fc7);

                if (_parameter_e24a3fc7Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_e24a3fc7Proxy__, message->Response());
                }
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_e24a3fc7) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_e24a3fc7));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_e24a3fc7), Exchange::IStream::ICallback::ID }, { 0, 0 } };
