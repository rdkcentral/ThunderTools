...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_d882639cInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_d882639c{};
                ProxyStub::UnknownProxy* _parameter_d882639cProxy__ = nullptr;
                if (_parameter_d882639cInstanceId__ != 0) {
                    _parameter_d882639cProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_d882639cInstanceId__, false, _parameter_d882639c);
                    ASSERT((_parameter_d882639c != nullptr) && (_parameter_d882639cProxy__ != nullptr));
                    if ((_parameter_d882639c == nullptr) || (_parameter_d882639cProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_d882639c);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_d882639cProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_d882639cProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_d45135b0InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_d45135b0{};
                ProxyStub::UnknownProxy* _parameter_d45135b0Proxy__ = nullptr;
                if (_parameter_d45135b0InstanceId__ != 0) {
                    _parameter_d45135b0Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_d45135b0InstanceId__, false, _parameter_d45135b0);
                    ASSERT((_parameter_d45135b0 != nullptr) && (_parameter_d45135b0Proxy__ != nullptr));
                    if ((_parameter_d45135b0 == nullptr) || (_parameter_d45135b0Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_d45135b0);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_d45135b0Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_d45135b0Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_d882639c) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_d882639c));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_d882639c), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_d45135b0) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_d45135b0));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_d45135b0), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
