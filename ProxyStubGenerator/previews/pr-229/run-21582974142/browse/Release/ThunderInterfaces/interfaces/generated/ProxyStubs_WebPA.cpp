...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_5320e669InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_5320e669{};
                ProxyStub::UnknownProxy* _parameter_5320e669Proxy__ = nullptr;
                if (_parameter_5320e669InstanceId__ != 0) {
                    _parameter_5320e669Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_5320e669InstanceId__, false, _parameter_5320e669);
                    ASSERT((_parameter_5320e669 != nullptr) && (_parameter_5320e669Proxy__ != nullptr));
                    if ((_parameter_5320e669 == nullptr) || (_parameter_5320e669Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Initialize(_parameter_5320e669);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_5320e669Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_5320e669Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_1922fdaeInstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_1922fdae{};
                ProxyStub::UnknownProxy* _parameter_1922fdaeProxy__ = nullptr;
                if (_parameter_1922fdaeInstanceId__ != 0) {
                    _parameter_1922fdaeProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_1922fdaeInstanceId__, false, _parameter_1922fdae);
                    ASSERT((_parameter_1922fdae != nullptr) && (_parameter_1922fdaeProxy__ != nullptr));
                    if ((_parameter_1922fdae == nullptr) || (_parameter_1922fdaeProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deinitialize(_parameter_1922fdae);

                if (_parameter_1922fdaeProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_1922fdaeProxy__, message->Response());
                }
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_8ae87eceInstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_8ae87ece{};
                ProxyStub::UnknownProxy* _parameter_8ae87eceProxy__ = nullptr;
                if (_parameter_8ae87eceInstanceId__ != 0) {
                    _parameter_8ae87eceProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_8ae87eceInstanceId__, false, _parameter_8ae87ece);
                    ASSERT((_parameter_8ae87ece != nullptr) && (_parameter_8ae87eceProxy__ != nullptr));
                    if ((_parameter_8ae87ece == nullptr) || (_parameter_8ae87eceProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Configure(_parameter_8ae87ece);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_8ae87eceProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_8ae87eceProxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_5320e669) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_5320e669));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_5320e669), PluginHost::IShell::ID }, { 0, 0 } };
        ...
        void Deinitialize(PluginHost::IShell* _parameter_1922fdae) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_1922fdae));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_1922fdae), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_8ae87ece) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_8ae87ece));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_8ae87ece), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
