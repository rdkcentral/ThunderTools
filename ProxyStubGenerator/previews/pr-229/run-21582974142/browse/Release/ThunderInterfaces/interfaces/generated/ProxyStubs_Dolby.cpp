...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_61d77b0aInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_61d77b0a{};
                ProxyStub::UnknownProxy* _parameter_61d77b0aProxy__ = nullptr;
                if (_parameter_61d77b0aInstanceId__ != 0) {
                    _parameter_61d77b0aProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_61d77b0aInstanceId__, false, _parameter_61d77b0a);
                    ASSERT((_parameter_61d77b0a != nullptr) && (_parameter_61d77b0aProxy__ != nullptr));
                    if ((_parameter_61d77b0a == nullptr) || (_parameter_61d77b0aProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_61d77b0a);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_61d77b0aProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_61d77b0aProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_6c552666InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_6c552666{};
                ProxyStub::UnknownProxy* _parameter_6c552666Proxy__ = nullptr;
                if (_parameter_6c552666InstanceId__ != 0) {
                    _parameter_6c552666Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_6c552666InstanceId__, false, _parameter_6c552666);
                    ASSERT((_parameter_6c552666 != nullptr) && (_parameter_6c552666Proxy__ != nullptr));
                    if ((_parameter_6c552666 == nullptr) || (_parameter_6c552666Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_6c552666);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_6c552666Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_6c552666Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_61d77b0a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_61d77b0a));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_61d77b0a), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_6c552666) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_6c552666));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_6c552666), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
