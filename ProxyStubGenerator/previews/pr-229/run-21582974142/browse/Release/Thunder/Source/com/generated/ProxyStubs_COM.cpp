...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_063ecb55InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_063ecb55{};
                ProxyStub::UnknownProxy* _parameter_063ecb55Proxy__ = nullptr;
                if (_parameter_063ecb55InstanceId__ != 0) {
                    _parameter_063ecb55Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_063ecb55InstanceId__, false, _parameter_063ecb55);
                    ASSERT((_parameter_063ecb55 != nullptr) && (_parameter_063ecb55Proxy__ != nullptr));
                    if ((_parameter_063ecb55 == nullptr) || (_parameter_063ecb55Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Activated(_parameter_063ecb55);

                if (_parameter_063ecb55Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_063ecb55Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_cba11d6cInstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_cba11d6c{};
                ProxyStub::UnknownProxy* _parameter_cba11d6cProxy__ = nullptr;
                if (_parameter_cba11d6cInstanceId__ != 0) {
                    _parameter_cba11d6cProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_cba11d6cInstanceId__, false, _parameter_cba11d6c);
                    ASSERT((_parameter_cba11d6c != nullptr) && (_parameter_cba11d6cProxy__ != nullptr));
                    if ((_parameter_cba11d6c == nullptr) || (_parameter_cba11d6cProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deactivated(_parameter_cba11d6c);

                if (_parameter_cba11d6cProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_cba11d6cProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_27e86682InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_27e86682{};
                ProxyStub::UnknownProxy* _parameter_27e86682Proxy__ = nullptr;
                if (_parameter_27e86682InstanceId__ != 0) {
                    _parameter_27e86682Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_27e86682InstanceId__, false, _parameter_27e86682);
                    ASSERT((_parameter_27e86682 != nullptr) && (_parameter_27e86682Proxy__ != nullptr));
                    if ((_parameter_27e86682 == nullptr) || (_parameter_27e86682Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Terminated(_parameter_27e86682);

                if (_parameter_27e86682Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_27e86682Proxy__, message->Response());
                }
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_063ecb55) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_063ecb55));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_063ecb55), IRemoteConnection::ID }, { 0, 0 } };
        ...
        void Deactivated(IRemoteConnection* _parameter_cba11d6c) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_cba11d6c));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_cba11d6c), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
        ...
        void Terminated(IRemoteConnection* _parameter_27e86682) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_27e86682));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_27e86682), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
