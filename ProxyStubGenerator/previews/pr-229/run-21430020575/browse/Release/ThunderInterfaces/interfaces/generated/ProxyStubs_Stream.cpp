...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_62765d8aInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IStream::ICallback* _parameter_62765d8a{};
                ProxyStub::UnknownProxy* _parameter_62765d8aProxy__ = nullptr;
                if (_parameter_62765d8aInstanceId__ != 0) {
                    _parameter_62765d8aProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_62765d8aInstanceId__, false, _parameter_62765d8a);
                    ASSERT((_parameter_62765d8a != nullptr) && (_parameter_62765d8aProxy__ != nullptr));
                    if ((_parameter_62765d8a == nullptr) || (_parameter_62765d8aProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Callback(_parameter_62765d8a);

                if (_parameter_62765d8aProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_62765d8aProxy__, message->Response());
                }
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_62765d8a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_62765d8a));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_62765d8a), Exchange::IStream::ICallback::ID }, { 0, 0 } };
