...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_1cb9ebb4InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_1cb9ebb4{};
                ProxyStub::UnknownProxy* _parameter_1cb9ebb4Proxy__ = nullptr;
                if (_parameter_1cb9ebb4InstanceId__ != 0) {
                    _parameter_1cb9ebb4Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_1cb9ebb4InstanceId__, false, _parameter_1cb9ebb4);
                    ASSERT((_parameter_1cb9ebb4 != nullptr) && (_parameter_1cb9ebb4Proxy__ != nullptr));
                    if ((_parameter_1cb9ebb4 == nullptr) || (_parameter_1cb9ebb4Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Initialize(_parameter_1cb9ebb4);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_1cb9ebb4Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_1cb9ebb4Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_b8035da4InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_b8035da4{};
                ProxyStub::UnknownProxy* _parameter_b8035da4Proxy__ = nullptr;
                if (_parameter_b8035da4InstanceId__ != 0) {
                    _parameter_b8035da4Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_b8035da4InstanceId__, false, _parameter_b8035da4);
                    ASSERT((_parameter_b8035da4 != nullptr) && (_parameter_b8035da4Proxy__ != nullptr));
                    if ((_parameter_b8035da4 == nullptr) || (_parameter_b8035da4Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deinitialize(_parameter_b8035da4);

                if (_parameter_b8035da4Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_b8035da4Proxy__, message->Response());
                }
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_77207012InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_77207012{};
                ProxyStub::UnknownProxy* _parameter_77207012Proxy__ = nullptr;
                if (_parameter_77207012InstanceId__ != 0) {
                    _parameter_77207012Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_77207012InstanceId__, false, _parameter_77207012);
                    ASSERT((_parameter_77207012 != nullptr) && (_parameter_77207012Proxy__ != nullptr));
                    if ((_parameter_77207012 == nullptr) || (_parameter_77207012Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Configure(_parameter_77207012);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_77207012Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_77207012Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_1cb9ebb4) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_1cb9ebb4));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_1cb9ebb4), PluginHost::IShell::ID }, { 0, 0 } };
        ...
        void Deinitialize(PluginHost::IShell* _parameter_b8035da4) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_b8035da4));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_b8035da4), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_77207012) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_77207012));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_77207012), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
