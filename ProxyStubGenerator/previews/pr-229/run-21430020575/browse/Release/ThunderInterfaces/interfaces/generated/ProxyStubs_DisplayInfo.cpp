...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_829f762bInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_829f762b{};
                ProxyStub::UnknownProxy* _parameter_829f762bProxy__ = nullptr;
                if (_parameter_829f762bInstanceId__ != 0) {
                    _parameter_829f762bProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_829f762bInstanceId__, false, _parameter_829f762b);
                    ASSERT((_parameter_829f762b != nullptr) && (_parameter_829f762bProxy__ != nullptr));
                    if ((_parameter_829f762b == nullptr) || (_parameter_829f762bProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_829f762b);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_829f762bProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_829f762bProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_11d29684InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_11d29684{};
                ProxyStub::UnknownProxy* _parameter_11d29684Proxy__ = nullptr;
                if (_parameter_11d29684InstanceId__ != 0) {
                    _parameter_11d29684Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_11d29684InstanceId__, false, _parameter_11d29684);
                    ASSERT((_parameter_11d29684 != nullptr) && (_parameter_11d29684Proxy__ != nullptr));
                    if ((_parameter_11d29684 == nullptr) || (_parameter_11d29684Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_11d29684);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_11d29684Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_11d29684Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_829f762b) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_829f762b));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_829f762b), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_11d29684) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_11d29684));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_11d29684), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
