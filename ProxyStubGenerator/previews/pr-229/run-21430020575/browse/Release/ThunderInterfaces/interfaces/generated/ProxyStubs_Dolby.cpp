...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_3c440cdeInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_3c440cde{};
                ProxyStub::UnknownProxy* _parameter_3c440cdeProxy__ = nullptr;
                if (_parameter_3c440cdeInstanceId__ != 0) {
                    _parameter_3c440cdeProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_3c440cdeInstanceId__, false, _parameter_3c440cde);
                    ASSERT((_parameter_3c440cde != nullptr) && (_parameter_3c440cdeProxy__ != nullptr));
                    if ((_parameter_3c440cde == nullptr) || (_parameter_3c440cdeProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_3c440cde);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_3c440cdeProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_3c440cdeProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_058619c3InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_058619c3{};
                ProxyStub::UnknownProxy* _parameter_058619c3Proxy__ = nullptr;
                if (_parameter_058619c3InstanceId__ != 0) {
                    _parameter_058619c3Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_058619c3InstanceId__, false, _parameter_058619c3);
                    ASSERT((_parameter_058619c3 != nullptr) && (_parameter_058619c3Proxy__ != nullptr));
                    if ((_parameter_058619c3 == nullptr) || (_parameter_058619c3Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_058619c3);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_058619c3Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_058619c3Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_3c440cde) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_3c440cde));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_3c440cde), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_058619c3) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_058619c3));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_058619c3), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
