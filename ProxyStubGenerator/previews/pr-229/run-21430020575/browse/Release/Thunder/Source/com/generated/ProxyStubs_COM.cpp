...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_6bc90597InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_6bc90597{};
                ProxyStub::UnknownProxy* _parameter_6bc90597Proxy__ = nullptr;
                if (_parameter_6bc90597InstanceId__ != 0) {
                    _parameter_6bc90597Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_6bc90597InstanceId__, false, _parameter_6bc90597);
                    ASSERT((_parameter_6bc90597 != nullptr) && (_parameter_6bc90597Proxy__ != nullptr));
                    if ((_parameter_6bc90597 == nullptr) || (_parameter_6bc90597Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Activated(_parameter_6bc90597);

                if (_parameter_6bc90597Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_6bc90597Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_ecf68755InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_ecf68755{};
                ProxyStub::UnknownProxy* _parameter_ecf68755Proxy__ = nullptr;
                if (_parameter_ecf68755InstanceId__ != 0) {
                    _parameter_ecf68755Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_ecf68755InstanceId__, false, _parameter_ecf68755);
                    ASSERT((_parameter_ecf68755 != nullptr) && (_parameter_ecf68755Proxy__ != nullptr));
                    if ((_parameter_ecf68755 == nullptr) || (_parameter_ecf68755Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deactivated(_parameter_ecf68755);

                if (_parameter_ecf68755Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_ecf68755Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_1e83ea5dInstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_1e83ea5d{};
                ProxyStub::UnknownProxy* _parameter_1e83ea5dProxy__ = nullptr;
                if (_parameter_1e83ea5dInstanceId__ != 0) {
                    _parameter_1e83ea5dProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_1e83ea5dInstanceId__, false, _parameter_1e83ea5d);
                    ASSERT((_parameter_1e83ea5d != nullptr) && (_parameter_1e83ea5dProxy__ != nullptr));
                    if ((_parameter_1e83ea5d == nullptr) || (_parameter_1e83ea5dProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Terminated(_parameter_1e83ea5d);

                if (_parameter_1e83ea5dProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_1e83ea5dProxy__, message->Response());
                }
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_6bc90597) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_6bc90597));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_6bc90597), IRemoteConnection::ID }, { 0, 0 } };
        ...
        void Deactivated(IRemoteConnection* _parameter_ecf68755) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_ecf68755));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_ecf68755), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
        ...
        void Terminated(IRemoteConnection* _parameter_1e83ea5d) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_1e83ea5d));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_1e83ea5d), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
