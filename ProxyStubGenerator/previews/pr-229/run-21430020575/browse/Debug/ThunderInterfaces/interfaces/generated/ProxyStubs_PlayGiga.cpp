...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_2c7bff54 = reader.Text();
            const string _parameter_a0ed3238 = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_2c7bff54), static_cast<const string&>(_parameter_a0ed3238));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_2c7bff54, const string& _parameter_a0ed3238) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_2c7bff54);
            writer.Text(_parameter_a0ed3238);
