...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_10bfe75dInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_10bfe75d{};
            ProxyStub::UnknownProxy* _parameter_10bfe75dProxy__ = nullptr;
            if (_parameter_10bfe75dInstanceId__ != 0) {
                _parameter_10bfe75dProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_10bfe75dInstanceId__, false, _parameter_10bfe75d);
                ASSERT((_parameter_10bfe75d != nullptr) && (_parameter_10bfe75dProxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_10bfe75d);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_10bfe75dProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_10bfe75dProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_4b84abb6InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_4b84abb6{};
            ProxyStub::UnknownProxy* _parameter_4b84abb6Proxy__ = nullptr;
            if (_parameter_4b84abb6InstanceId__ != 0) {
                _parameter_4b84abb6Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_4b84abb6InstanceId__, false, _parameter_4b84abb6);
                ASSERT((_parameter_4b84abb6 != nullptr) && (_parameter_4b84abb6Proxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_4b84abb6);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_4b84abb6Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_4b84abb6Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_10bfe75d) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_10bfe75d));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_4b84abb6) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_4b84abb6));
