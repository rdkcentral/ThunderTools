...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeSessionStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_316a166d = reader.Text();
            const string _parameter_adb058e8 = reader.Text();

            Exchange::OCDM_RESULT result = implementation->SetParameter(static_cast<const string&>(_parameter_316a166d), static_cast<const string&>(_parameter_adb058e8));
    ...
    public:
        ...
        Exchange::OCDM_RESULT SetParameter(const string& _parameter_316a166d, const string& _parameter_adb058e8) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(13));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_316a166d);
            writer.Text(_parameter_adb058e8);
