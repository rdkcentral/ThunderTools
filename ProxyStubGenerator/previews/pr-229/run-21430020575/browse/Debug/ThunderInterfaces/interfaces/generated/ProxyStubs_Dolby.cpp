...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_15316e50InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_15316e50{};
            ProxyStub::UnknownProxy* _parameter_15316e50Proxy__ = nullptr;
            if (_parameter_15316e50InstanceId__ != 0) {
                _parameter_15316e50Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_15316e50InstanceId__, false, _parameter_15316e50);
                ASSERT((_parameter_15316e50 != nullptr) && (_parameter_15316e50Proxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_15316e50);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_15316e50Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_15316e50Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_fe9b3b56InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_fe9b3b56{};
            ProxyStub::UnknownProxy* _parameter_fe9b3b56Proxy__ = nullptr;
            if (_parameter_fe9b3b56InstanceId__ != 0) {
                _parameter_fe9b3b56Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_fe9b3b56InstanceId__, false, _parameter_fe9b3b56);
                ASSERT((_parameter_fe9b3b56 != nullptr) && (_parameter_fe9b3b56Proxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_fe9b3b56);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_fe9b3b56Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_fe9b3b56Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_15316e50) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_15316e50));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_fe9b3b56) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_fe9b3b56));
