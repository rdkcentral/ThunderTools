...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_e328430bInstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IStream::ICallback* _parameter_e328430b{};
            ProxyStub::UnknownProxy* _parameter_e328430bProxy__ = nullptr;
            if (_parameter_e328430bInstanceId__ != 0) {
                _parameter_e328430bProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_e328430bInstanceId__, false, _parameter_e328430b);
                ASSERT((_parameter_e328430b != nullptr) && (_parameter_e328430bProxy__ != nullptr));
            }

            implementation->Callback(_parameter_e328430b);

            if (_parameter_e328430bProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_e328430bProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_e328430b) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_e328430b));
