...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_9272a730InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_9272a730{};
            ProxyStub::UnknownProxy* _parameter_9272a730Proxy__ = nullptr;
            if (_parameter_9272a730InstanceId__ != 0) {
                _parameter_9272a730Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_9272a730InstanceId__, false, _parameter_9272a730);
                ASSERT((_parameter_9272a730 != nullptr) && (_parameter_9272a730Proxy__ != nullptr));
            }

            implementation->Activated(_parameter_9272a730);

            if (_parameter_9272a730Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_9272a730Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_0c6ef70fInstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_0c6ef70f{};
            ProxyStub::UnknownProxy* _parameter_0c6ef70fProxy__ = nullptr;
            if (_parameter_0c6ef70fInstanceId__ != 0) {
                _parameter_0c6ef70fProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_0c6ef70fInstanceId__, false, _parameter_0c6ef70f);
                ASSERT((_parameter_0c6ef70f != nullptr) && (_parameter_0c6ef70fProxy__ != nullptr));
            }

            implementation->Deactivated(_parameter_0c6ef70f);

            if (_parameter_0c6ef70fProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_0c6ef70fProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_ffa5e9f9InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_ffa5e9f9{};
            ProxyStub::UnknownProxy* _parameter_ffa5e9f9Proxy__ = nullptr;
            if (_parameter_ffa5e9f9InstanceId__ != 0) {
                _parameter_ffa5e9f9Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_ffa5e9f9InstanceId__, false, _parameter_ffa5e9f9);
                ASSERT((_parameter_ffa5e9f9 != nullptr) && (_parameter_ffa5e9f9Proxy__ != nullptr));
            }

            implementation->Terminated(_parameter_ffa5e9f9);

            if (_parameter_ffa5e9f9Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_ffa5e9f9Proxy__, message->Response());
            }
        }
        , nullptr
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_9272a730) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_9272a730));
        ...
        void Deactivated(IRemoteConnection* _parameter_0c6ef70f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_0c6ef70f));
        ...
        void Terminated(IRemoteConnection* _parameter_ffa5e9f9) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_ffa5e9f9));
