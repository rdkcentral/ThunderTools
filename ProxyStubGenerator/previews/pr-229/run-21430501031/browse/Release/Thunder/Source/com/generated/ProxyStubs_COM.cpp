...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_968246feInstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_968246fe{};
                ProxyStub::UnknownProxy* _parameter_968246feProxy__ = nullptr;
                if (_parameter_968246feInstanceId__ != 0) {
                    _parameter_968246feProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_968246feInstanceId__, false, _parameter_968246fe);
                    ASSERT((_parameter_968246fe != nullptr) && (_parameter_968246feProxy__ != nullptr));
                    if ((_parameter_968246fe == nullptr) || (_parameter_968246feProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Activated(_parameter_968246fe);

                if (_parameter_968246feProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_968246feProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_be7be4fdInstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_be7be4fd{};
                ProxyStub::UnknownProxy* _parameter_be7be4fdProxy__ = nullptr;
                if (_parameter_be7be4fdInstanceId__ != 0) {
                    _parameter_be7be4fdProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_be7be4fdInstanceId__, false, _parameter_be7be4fd);
                    ASSERT((_parameter_be7be4fd != nullptr) && (_parameter_be7be4fdProxy__ != nullptr));
                    if ((_parameter_be7be4fd == nullptr) || (_parameter_be7be4fdProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deactivated(_parameter_be7be4fd);

                if (_parameter_be7be4fdProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_be7be4fdProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_283cc663InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_283cc663{};
                ProxyStub::UnknownProxy* _parameter_283cc663Proxy__ = nullptr;
                if (_parameter_283cc663InstanceId__ != 0) {
                    _parameter_283cc663Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_283cc663InstanceId__, false, _parameter_283cc663);
                    ASSERT((_parameter_283cc663 != nullptr) && (_parameter_283cc663Proxy__ != nullptr));
                    if ((_parameter_283cc663 == nullptr) || (_parameter_283cc663Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Terminated(_parameter_283cc663);

                if (_parameter_283cc663Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_283cc663Proxy__, message->Response());
                }
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_968246fe) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_968246fe));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_968246fe), IRemoteConnection::ID }, { 0, 0 } };
        ...
        void Deactivated(IRemoteConnection* _parameter_be7be4fd) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_be7be4fd));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_be7be4fd), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
        ...
        void Terminated(IRemoteConnection* _parameter_283cc663) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_283cc663));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_283cc663), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
