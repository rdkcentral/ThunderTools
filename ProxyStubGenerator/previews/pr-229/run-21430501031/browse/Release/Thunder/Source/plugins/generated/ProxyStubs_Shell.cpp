...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ShellStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                const IShell::reason _parameter_74023e55 = reader.Number<IShell::reason>();

                Core::hresult result = implementation->Activate(_parameter_74023e55);
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (Core::RealSize<IShell::reason>())) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                const IShell::reason _parameter_a40ba583 = reader.Number<IShell::reason>();

                Core::hresult result = implementation->Deactivate(_parameter_a40ba583);
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (Core::RealSize<IShell::reason>())) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                const IShell::reason _parameter_5c90bc8d = reader.Number<IShell::reason>();

                Core::hresult result = implementation->Unavailable(_parameter_5c90bc8d);
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (Core::RealSize<uint16_t>())) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                const uint16_t _parameter_3d5a3cefPeekedLen__ = reader.PeekNumber<uint16_t>();
                if (reader.Length() < (static_cast<uint32_t>(Core::RealSize<uint16_t>()) + _parameter_3d5a3cefPeekedLen__)) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                const string _parameter_3d5a3cef = reader.Text();

                RPC::IStringIterator* result = implementation->GetLibrarySearchPaths(static_cast<const string&>(_parameter_3d5a3cef));
    ...
    public:
        ...
        Core::hresult Activate(const IShell::reason _parameter_74023e55) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(32));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<IShell::reason>(_parameter_74023e55);
        ...
        Core::hresult Deactivate(const IShell::reason _parameter_a40ba583) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(33));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<IShell::reason>(_parameter_a40ba583);
        ...
        Core::hresult Unavailable(const IShell::reason _parameter_5c90bc8d) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(34));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<IShell::reason>(_parameter_5c90bc8d);
        ...
        RPC::IStringIterator* GetLibrarySearchPaths(const string& _parameter_3d5a3cef) const override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(38));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_3d5a3cef);
