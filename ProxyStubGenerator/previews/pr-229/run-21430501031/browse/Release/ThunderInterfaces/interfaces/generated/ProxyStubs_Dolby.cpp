...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_a50131f2InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_a50131f2{};
                ProxyStub::UnknownProxy* _parameter_a50131f2Proxy__ = nullptr;
                if (_parameter_a50131f2InstanceId__ != 0) {
                    _parameter_a50131f2Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_a50131f2InstanceId__, false, _parameter_a50131f2);
                    ASSERT((_parameter_a50131f2 != nullptr) && (_parameter_a50131f2Proxy__ != nullptr));
                    if ((_parameter_a50131f2 == nullptr) || (_parameter_a50131f2Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_a50131f2);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_a50131f2Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_a50131f2Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_49a4f647InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_49a4f647{};
                ProxyStub::UnknownProxy* _parameter_49a4f647Proxy__ = nullptr;
                if (_parameter_49a4f647InstanceId__ != 0) {
                    _parameter_49a4f647Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_49a4f647InstanceId__, false, _parameter_49a4f647);
                    ASSERT((_parameter_49a4f647 != nullptr) && (_parameter_49a4f647Proxy__ != nullptr));
                    if ((_parameter_49a4f647 == nullptr) || (_parameter_49a4f647Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_49a4f647);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_49a4f647Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_49a4f647Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_a50131f2) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_a50131f2));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_a50131f2), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_49a4f647) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_49a4f647));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_49a4f647), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
