...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_e06cc3e6InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_e06cc3e6{};
                ProxyStub::UnknownProxy* _parameter_e06cc3e6Proxy__ = nullptr;
                if (_parameter_e06cc3e6InstanceId__ != 0) {
                    _parameter_e06cc3e6Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_e06cc3e6InstanceId__, false, _parameter_e06cc3e6);
                    ASSERT((_parameter_e06cc3e6 != nullptr) && (_parameter_e06cc3e6Proxy__ != nullptr));
                    if ((_parameter_e06cc3e6 == nullptr) || (_parameter_e06cc3e6Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Initialize(_parameter_e06cc3e6);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_e06cc3e6Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_e06cc3e6Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_d22353d0InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_d22353d0{};
                ProxyStub::UnknownProxy* _parameter_d22353d0Proxy__ = nullptr;
                if (_parameter_d22353d0InstanceId__ != 0) {
                    _parameter_d22353d0Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_d22353d0InstanceId__, false, _parameter_d22353d0);
                    ASSERT((_parameter_d22353d0 != nullptr) && (_parameter_d22353d0Proxy__ != nullptr));
                    if ((_parameter_d22353d0 == nullptr) || (_parameter_d22353d0Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deinitialize(_parameter_d22353d0);

                if (_parameter_d22353d0Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_d22353d0Proxy__, message->Response());
                }
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_5d722b44InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_5d722b44{};
                ProxyStub::UnknownProxy* _parameter_5d722b44Proxy__ = nullptr;
                if (_parameter_5d722b44InstanceId__ != 0) {
                    _parameter_5d722b44Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_5d722b44InstanceId__, false, _parameter_5d722b44);
                    ASSERT((_parameter_5d722b44 != nullptr) && (_parameter_5d722b44Proxy__ != nullptr));
                    if ((_parameter_5d722b44 == nullptr) || (_parameter_5d722b44Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Configure(_parameter_5d722b44);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_5d722b44Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_5d722b44Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_e06cc3e6) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_e06cc3e6));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_e06cc3e6), PluginHost::IShell::ID }, { 0, 0 } };
        ...
        void Deinitialize(PluginHost::IShell* _parameter_d22353d0) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_d22353d0));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_d22353d0), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_5d722b44) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_5d722b44));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_5d722b44), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
