...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_09362bebInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_09362beb{};
                ProxyStub::UnknownProxy* _parameter_09362bebProxy__ = nullptr;
                if (_parameter_09362bebInstanceId__ != 0) {
                    _parameter_09362bebProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_09362bebInstanceId__, false, _parameter_09362beb);
                    ASSERT((_parameter_09362beb != nullptr) && (_parameter_09362bebProxy__ != nullptr));
                    if ((_parameter_09362beb == nullptr) || (_parameter_09362bebProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_09362beb);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_09362bebProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_09362bebProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_c038b3ccInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IConnectionProperties::INotification* _parameter_c038b3cc{};
                ProxyStub::UnknownProxy* _parameter_c038b3ccProxy__ = nullptr;
                if (_parameter_c038b3ccInstanceId__ != 0) {
                    _parameter_c038b3ccProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_c038b3ccInstanceId__, false, _parameter_c038b3cc);
                    ASSERT((_parameter_c038b3cc != nullptr) && (_parameter_c038b3ccProxy__ != nullptr));
                    if ((_parameter_c038b3cc == nullptr) || (_parameter_c038b3ccProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_c038b3cc);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_c038b3ccProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_c038b3ccProxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_09362beb) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_09362beb));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_09362beb), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_c038b3cc) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_c038b3cc));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_c038b3cc), Exchange::IConnectionProperties::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
