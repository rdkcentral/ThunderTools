...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeAVNClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_e80ca898InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_e80ca898{};
            ProxyStub::UnknownProxy* _parameter_e80ca898Proxy__ = nullptr;
            if (_parameter_e80ca898InstanceId__ != 0) {
                _parameter_e80ca898Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_e80ca898InstanceId__, false, _parameter_e80ca898);
                ASSERT((_parameter_e80ca898 != nullptr) && (_parameter_e80ca898Proxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_e80ca898);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_e80ca898Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_e80ca898Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_bacd88a0 = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_bacd88a0));
        }
        , nullptr
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_e80ca898) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_e80ca898));
        ...
        void Launch(const string& _parameter_bacd88a0) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_bacd88a0);
