...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_38e32168InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_38e32168{};
            ProxyStub::UnknownProxy* _parameter_38e32168Proxy__ = nullptr;
            if (_parameter_38e32168InstanceId__ != 0) {
                _parameter_38e32168Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_38e32168InstanceId__, false, _parameter_38e32168);
                ASSERT((_parameter_38e32168 != nullptr) && (_parameter_38e32168Proxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_38e32168);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_38e32168Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_38e32168Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_0fb43c10InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_0fb43c10{};
            ProxyStub::UnknownProxy* _parameter_0fb43c10Proxy__ = nullptr;
            if (_parameter_0fb43c10InstanceId__ != 0) {
                _parameter_0fb43c10Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_0fb43c10InstanceId__, false, _parameter_0fb43c10);
                ASSERT((_parameter_0fb43c10 != nullptr) && (_parameter_0fb43c10Proxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_0fb43c10);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_0fb43c10Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_0fb43c10Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_38e32168) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_38e32168));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_0fb43c10) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_0fb43c10));
