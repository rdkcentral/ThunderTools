...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_37487bec = reader.Text();
            const string _parameter_2f5924d8 = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_37487bec), static_cast<const string&>(_parameter_2f5924d8));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_37487bec, const string& _parameter_2f5924d8) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_37487bec);
            writer.Text(_parameter_2f5924d8);
