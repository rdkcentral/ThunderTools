...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeConnectionPropertiesStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_c2ccd345InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_c2ccd345{};
            ProxyStub::UnknownProxy* _parameter_c2ccd345Proxy__ = nullptr;
            if (_parameter_c2ccd345InstanceId__ != 0) {
                _parameter_c2ccd345Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_c2ccd345InstanceId__, false, _parameter_c2ccd345);
                ASSERT((_parameter_c2ccd345 != nullptr) && (_parameter_c2ccd345Proxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_c2ccd345);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_c2ccd345Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_c2ccd345Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_1bf1ee88InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IConnectionProperties::INotification* _parameter_1bf1ee88{};
            ProxyStub::UnknownProxy* _parameter_1bf1ee88Proxy__ = nullptr;
            if (_parameter_1bf1ee88InstanceId__ != 0) {
                _parameter_1bf1ee88Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_1bf1ee88InstanceId__, false, _parameter_1bf1ee88);
                ASSERT((_parameter_1bf1ee88 != nullptr) && (_parameter_1bf1ee88Proxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_1bf1ee88);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_1bf1ee88Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_1bf1ee88Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::IConnectionProperties::INotification* _parameter_c2ccd345) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_c2ccd345));
        ...
        uint32_t Unregister(Exchange::IConnectionProperties::INotification* _parameter_1bf1ee88) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_1bf1ee88));
