...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_31364ceeInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_31364cee{};
            ProxyStub::UnknownProxy* _parameter_31364ceeProxy__ = nullptr;
            if (_parameter_31364ceeInstanceId__ != 0) {
                _parameter_31364ceeProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_31364ceeInstanceId__, false, _parameter_31364cee);
                ASSERT((_parameter_31364cee != nullptr) && (_parameter_31364ceeProxy__ != nullptr));
            }

            uint32_t result = implementation->Initialize(_parameter_31364cee);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_31364ceeProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_31364ceeProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_02a36e8aInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_02a36e8a{};
            ProxyStub::UnknownProxy* _parameter_02a36e8aProxy__ = nullptr;
            if (_parameter_02a36e8aInstanceId__ != 0) {
                _parameter_02a36e8aProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_02a36e8aInstanceId__, false, _parameter_02a36e8a);
                ASSERT((_parameter_02a36e8a != nullptr) && (_parameter_02a36e8aProxy__ != nullptr));
            }

            implementation->Deinitialize(_parameter_02a36e8a);

            if (_parameter_02a36e8aProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_02a36e8aProxy__, message->Response());
            }
        },
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_2b0d981dInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_2b0d981d{};
            ProxyStub::UnknownProxy* _parameter_2b0d981dProxy__ = nullptr;
            if (_parameter_2b0d981dInstanceId__ != 0) {
                _parameter_2b0d981dProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_2b0d981dInstanceId__, false, _parameter_2b0d981d);
                ASSERT((_parameter_2b0d981d != nullptr) && (_parameter_2b0d981dProxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_2b0d981d);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_2b0d981dProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_2b0d981dProxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_31364cee) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_31364cee));
        ...
        void Deinitialize(PluginHost::IShell* _parameter_02a36e8a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_02a36e8a));
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_2b0d981d) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_2b0d981d));
