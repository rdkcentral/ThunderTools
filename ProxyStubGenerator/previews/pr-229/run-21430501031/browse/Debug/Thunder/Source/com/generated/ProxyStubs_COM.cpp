...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_88b8d62fInstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_88b8d62f{};
            ProxyStub::UnknownProxy* _parameter_88b8d62fProxy__ = nullptr;
            if (_parameter_88b8d62fInstanceId__ != 0) {
                _parameter_88b8d62fProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_88b8d62fInstanceId__, false, _parameter_88b8d62f);
                ASSERT((_parameter_88b8d62f != nullptr) && (_parameter_88b8d62fProxy__ != nullptr));
            }

            implementation->Activated(_parameter_88b8d62f);

            if (_parameter_88b8d62fProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_88b8d62fProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_2026bbc5InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_2026bbc5{};
            ProxyStub::UnknownProxy* _parameter_2026bbc5Proxy__ = nullptr;
            if (_parameter_2026bbc5InstanceId__ != 0) {
                _parameter_2026bbc5Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_2026bbc5InstanceId__, false, _parameter_2026bbc5);
                ASSERT((_parameter_2026bbc5 != nullptr) && (_parameter_2026bbc5Proxy__ != nullptr));
            }

            implementation->Deactivated(_parameter_2026bbc5);

            if (_parameter_2026bbc5Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_2026bbc5Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_7f65eb2aInstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_7f65eb2a{};
            ProxyStub::UnknownProxy* _parameter_7f65eb2aProxy__ = nullptr;
            if (_parameter_7f65eb2aInstanceId__ != 0) {
                _parameter_7f65eb2aProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_7f65eb2aInstanceId__, false, _parameter_7f65eb2a);
                ASSERT((_parameter_7f65eb2a != nullptr) && (_parameter_7f65eb2aProxy__ != nullptr));
            }

            implementation->Terminated(_parameter_7f65eb2a);

            if (_parameter_7f65eb2aProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_7f65eb2aProxy__, message->Response());
            }
        }
        , nullptr
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_88b8d62f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_88b8d62f));
        ...
        void Deactivated(IRemoteConnection* _parameter_2026bbc5) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_2026bbc5));
        ...
        void Terminated(IRemoteConnection* _parameter_7f65eb2a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_7f65eb2a));
