...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_892a64faInstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_892a64fa{};
            ProxyStub::UnknownProxy* _parameter_892a64faProxy__ = nullptr;
            if (_parameter_892a64faInstanceId__ != 0) {
                _parameter_892a64faProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_892a64faInstanceId__, false, _parameter_892a64fa);
                ASSERT((_parameter_892a64fa != nullptr) && (_parameter_892a64faProxy__ != nullptr));
            }

            implementation->Activated(_parameter_892a64fa);

            if (_parameter_892a64faProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_892a64faProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_574e3580InstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_574e3580{};
            ProxyStub::UnknownProxy* _parameter_574e3580Proxy__ = nullptr;
            if (_parameter_574e3580InstanceId__ != 0) {
                _parameter_574e3580Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_574e3580InstanceId__, false, _parameter_574e3580);
                ASSERT((_parameter_574e3580 != nullptr) && (_parameter_574e3580Proxy__ != nullptr));
            }

            implementation->Deactivated(_parameter_574e3580);

            if (_parameter_574e3580Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_574e3580Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_fac2d6abInstanceId__ = reader.Number<Core::instance_id>();

            IRemoteConnection* _parameter_fac2d6ab{};
            ProxyStub::UnknownProxy* _parameter_fac2d6abProxy__ = nullptr;
            if (_parameter_fac2d6abInstanceId__ != 0) {
                _parameter_fac2d6abProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_fac2d6abInstanceId__, false, _parameter_fac2d6ab);
                ASSERT((_parameter_fac2d6ab != nullptr) && (_parameter_fac2d6abProxy__ != nullptr));
            }

            implementation->Terminated(_parameter_fac2d6ab);

            if (_parameter_fac2d6abProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_fac2d6abProxy__, message->Response());
            }
        }
        , nullptr
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_892a64fa) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_892a64fa));
        ...
        void Deactivated(IRemoteConnection* _parameter_574e3580) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_574e3580));
        ...
        void Terminated(IRemoteConnection* _parameter_fac2d6ab) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_fac2d6ab));
