...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_7f1a56e1InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::IStream::ICallback* _parameter_7f1a56e1{};
            ProxyStub::UnknownProxy* _parameter_7f1a56e1Proxy__ = nullptr;
            if (_parameter_7f1a56e1InstanceId__ != 0) {
                _parameter_7f1a56e1Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_7f1a56e1InstanceId__, false, _parameter_7f1a56e1);
                ASSERT((_parameter_7f1a56e1 != nullptr) && (_parameter_7f1a56e1Proxy__ != nullptr));
            }

            implementation->Callback(_parameter_7f1a56e1);

            if (_parameter_7f1a56e1Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_7f1a56e1Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_7f1a56e1) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_7f1a56e1));
