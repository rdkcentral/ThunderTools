...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeAVNClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_9080445fInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_9080445f{};
            ProxyStub::UnknownProxy* _parameter_9080445fProxy__ = nullptr;
            if (_parameter_9080445fInstanceId__ != 0) {
                _parameter_9080445fProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_9080445fInstanceId__, false, _parameter_9080445f);
                ASSERT((_parameter_9080445f != nullptr) && (_parameter_9080445fProxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_9080445f);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_9080445fProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_9080445fProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_0e04723f = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_0e04723f));
        }
        , nullptr
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_9080445f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_9080445f));
        ...
        void Launch(const string& _parameter_0e04723f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_0e04723f);
