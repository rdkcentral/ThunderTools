...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeSessionStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            const string _parameter_a26135bb = reader.Text();
            const string _parameter_a7e035c7 = reader.Text();

            Exchange::OCDM_RESULT result = implementation->SetParameter(static_cast<const string&>(_parameter_a26135bb), static_cast<const string&>(_parameter_a7e035c7));
    ...
    public:
        ...
        Exchange::OCDM_RESULT SetParameter(const string& _parameter_a26135bb, const string& _parameter_a7e035c7) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(13));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_a26135bb);
            writer.Text(_parameter_a7e035c7);
