...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_c1140949InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_c1140949{};
            ProxyStub::UnknownProxy* _parameter_c1140949Proxy__ = nullptr;
            if (_parameter_c1140949InstanceId__ != 0) {
                _parameter_c1140949Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_c1140949InstanceId__, false, _parameter_c1140949);
                ASSERT((_parameter_c1140949 != nullptr) && (_parameter_c1140949Proxy__ != nullptr));
            }

            uint32_t result = implementation->Register(_parameter_c1140949);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_c1140949Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_c1140949Proxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_84f2fea6InstanceId__ = reader.Number<Core::instance_id>();

            Exchange::Dolby::IOutput::INotification* _parameter_84f2fea6{};
            ProxyStub::UnknownProxy* _parameter_84f2fea6Proxy__ = nullptr;
            if (_parameter_84f2fea6InstanceId__ != 0) {
                _parameter_84f2fea6Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_84f2fea6InstanceId__, false, _parameter_84f2fea6);
                ASSERT((_parameter_84f2fea6 != nullptr) && (_parameter_84f2fea6Proxy__ != nullptr));
            }

            uint32_t result = implementation->Unregister(_parameter_84f2fea6);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_84f2fea6Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_84f2fea6Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_c1140949) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_c1140949));
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_84f2fea6) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_84f2fea6));
