...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            Core::instance_id _parameter_26d7ecccInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_26d7eccc{};
            ProxyStub::UnknownProxy* _parameter_26d7ecccProxy__ = nullptr;
            if (_parameter_26d7ecccInstanceId__ != 0) {
                _parameter_26d7ecccProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_26d7ecccInstanceId__, false, _parameter_26d7eccc);
                ASSERT((_parameter_26d7eccc != nullptr) && (_parameter_26d7ecccProxy__ != nullptr));
            }

            uint32_t result = implementation->Initialize(_parameter_26d7eccc);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_26d7ecccProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_26d7ecccProxy__, message->Response());
            }
        },
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_1f710d3fInstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_1f710d3f{};
            ProxyStub::UnknownProxy* _parameter_1f710d3fProxy__ = nullptr;
            if (_parameter_1f710d3fInstanceId__ != 0) {
                _parameter_1f710d3fProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_1f710d3fInstanceId__, false, _parameter_1f710d3f);
                ASSERT((_parameter_1f710d3f != nullptr) && (_parameter_1f710d3fProxy__ != nullptr));
            }

            implementation->Deinitialize(_parameter_1f710d3f);

            if (_parameter_1f710d3fProxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_1f710d3fProxy__, message->Response());
            }
        },
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            RPC::Data::Frame::Reader reader(message->Parameters().Reader());
            Core::instance_id _parameter_59ba1d98InstanceId__ = reader.Number<Core::instance_id>();

            PluginHost::IShell* _parameter_59ba1d98{};
            ProxyStub::UnknownProxy* _parameter_59ba1d98Proxy__ = nullptr;
            if (_parameter_59ba1d98InstanceId__ != 0) {
                _parameter_59ba1d98Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_59ba1d98InstanceId__, false, _parameter_59ba1d98);
                ASSERT((_parameter_59ba1d98 != nullptr) && (_parameter_59ba1d98Proxy__ != nullptr));
            }

            uint32_t result = implementation->Configure(_parameter_59ba1d98);

            RPC::Data::Frame::Writer writer(message->Response().Writer());
            writer.Number<uint32_t>(result);

            if (_parameter_59ba1d98Proxy__ != nullptr) {
                RPC::Administrator::Instance().Release(_parameter_59ba1d98Proxy__, message->Response());
            }
        },
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_26d7eccc) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_26d7eccc));
        ...
        void Deinitialize(PluginHost::IShell* _parameter_1f710d3f) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_1f710d3f));
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_59ba1d98) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_59ba1d98));
