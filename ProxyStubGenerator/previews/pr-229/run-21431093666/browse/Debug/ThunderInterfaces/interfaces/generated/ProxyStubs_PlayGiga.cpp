...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangePlayGigaStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& /* channel */, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            const string _parameter_7049ea09 = reader.Text();
            const string _parameter_62ca28a7 = reader.Text();

            implementation->Launch(static_cast<const string&>(_parameter_7049ea09), static_cast<const string&>(_parameter_62ca28a7));
        }
        , nullptr
    ...
    public:
        ...
        void Launch(const string& _parameter_7049ea09, const string& _parameter_62ca28a7) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_7049ea09);
            writer.Text(_parameter_62ca28a7);
