...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler RemoteConnectionNotificationStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_2c0713acInstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_2c0713ac{};
                ProxyStub::UnknownProxy* _parameter_2c0713acProxy__ = nullptr;
                if (_parameter_2c0713acInstanceId__ != 0) {
                    _parameter_2c0713acProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_2c0713acInstanceId__, false, _parameter_2c0713ac);
                    ASSERT((_parameter_2c0713ac != nullptr) && (_parameter_2c0713acProxy__ != nullptr));
                    if ((_parameter_2c0713ac == nullptr) || (_parameter_2c0713acProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Activated(_parameter_2c0713ac);

                if (_parameter_2c0713acProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_2c0713acProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_fed77575InstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_fed77575{};
                ProxyStub::UnknownProxy* _parameter_fed77575Proxy__ = nullptr;
                if (_parameter_fed77575InstanceId__ != 0) {
                    _parameter_fed77575Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_fed77575InstanceId__, false, _parameter_fed77575);
                    ASSERT((_parameter_fed77575 != nullptr) && (_parameter_fed77575Proxy__ != nullptr));
                    if ((_parameter_fed77575 == nullptr) || (_parameter_fed77575Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deactivated(_parameter_fed77575);

                if (_parameter_fed77575Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_fed77575Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_ae077c4bInstanceId__ = reader.Number<Core::instance_id>();

                IRemoteConnection* _parameter_ae077c4b{};
                ProxyStub::UnknownProxy* _parameter_ae077c4bProxy__ = nullptr;
                if (_parameter_ae077c4bInstanceId__ != 0) {
                    _parameter_ae077c4bProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_ae077c4bInstanceId__, false, _parameter_ae077c4b);
                    ASSERT((_parameter_ae077c4b != nullptr) && (_parameter_ae077c4bProxy__ != nullptr));
                    if ((_parameter_ae077c4b == nullptr) || (_parameter_ae077c4bProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Terminated(_parameter_ae077c4b);

                if (_parameter_ae077c4bProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_ae077c4bProxy__, message->Response());
                }
    ...
    public:
        ...
        void Activated(IRemoteConnection* _parameter_2c0713ac) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_2c0713ac));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_2c0713ac), IRemoteConnection::ID }, { 0, 0 } };
        ...
        void Deactivated(IRemoteConnection* _parameter_fed77575) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_fed77575));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_fed77575), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
        ...
        void Terminated(IRemoteConnection* _parameter_ae077c4b) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(2));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_ae077c4b));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_ae077c4b), IRemoteConnection::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
