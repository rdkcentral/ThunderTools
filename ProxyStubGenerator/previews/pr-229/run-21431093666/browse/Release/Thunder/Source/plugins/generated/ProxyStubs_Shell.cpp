...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ShellStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                const IShell::reason _parameter_cdffa9e1 = reader.Number<IShell::reason>();

                Core::hresult result = implementation->Activate(_parameter_cdffa9e1);
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (Core::RealSize<IShell::reason>())) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                const IShell::reason _parameter_1848708a = reader.Number<IShell::reason>();

                Core::hresult result = implementation->Deactivate(_parameter_1848708a);
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (Core::RealSize<IShell::reason>())) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                const IShell::reason _parameter_51871e82 = reader.Number<IShell::reason>();

                Core::hresult result = implementation->Unavailable(_parameter_51871e82);
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (Core::RealSize<uint16_t>())) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                const uint16_t _parameter_c110f46fPeekedLen__ = reader.PeekNumber<uint16_t>();
                if (reader.Length() < (static_cast<uint32_t>(Core::RealSize<uint16_t>()) + _parameter_c110f46fPeekedLen__)) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                const string _parameter_c110f46f = reader.Text();

                RPC::IStringIterator* result = implementation->GetLibrarySearchPaths(static_cast<const string&>(_parameter_c110f46f));
    ...
    public:
        ...
        Core::hresult Activate(const IShell::reason _parameter_cdffa9e1) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(32));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<IShell::reason>(_parameter_cdffa9e1);
        ...
        Core::hresult Deactivate(const IShell::reason _parameter_1848708a) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(33));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<IShell::reason>(_parameter_1848708a);
        ...
        Core::hresult Unavailable(const IShell::reason _parameter_51871e82) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(34));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<IShell::reason>(_parameter_51871e82);
        ...
        RPC::IStringIterator* GetLibrarySearchPaths(const string& _parameter_c110f46f) const override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(38));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Text(_parameter_c110f46f);
