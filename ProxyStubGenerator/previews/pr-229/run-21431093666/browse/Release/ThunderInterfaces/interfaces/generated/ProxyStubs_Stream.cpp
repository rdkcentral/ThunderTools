...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeStreamStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_cf82d8c9InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::IStream::ICallback* _parameter_cf82d8c9{};
                ProxyStub::UnknownProxy* _parameter_cf82d8c9Proxy__ = nullptr;
                if (_parameter_cf82d8c9InstanceId__ != 0) {
                    _parameter_cf82d8c9Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_cf82d8c9InstanceId__, false, _parameter_cf82d8c9);
                    ASSERT((_parameter_cf82d8c9 != nullptr) && (_parameter_cf82d8c9Proxy__ != nullptr));
                    if ((_parameter_cf82d8c9 == nullptr) || (_parameter_cf82d8c9Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Callback(_parameter_cf82d8c9);

                if (_parameter_cf82d8c9Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_cf82d8c9Proxy__, message->Response());
                }
    ...
    public:
        ...
        void Callback(Exchange::IStream::ICallback* _parameter_cf82d8c9) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(4));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_cf82d8c9));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_cf82d8c9), Exchange::IStream::ICallback::ID }, { 0, 0 } };
