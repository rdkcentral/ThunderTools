...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeWebPAStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_172ef471InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_172ef471{};
                ProxyStub::UnknownProxy* _parameter_172ef471Proxy__ = nullptr;
                if (_parameter_172ef471InstanceId__ != 0) {
                    _parameter_172ef471Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_172ef471InstanceId__, false, _parameter_172ef471);
                    ASSERT((_parameter_172ef471 != nullptr) && (_parameter_172ef471Proxy__ != nullptr));
                    if ((_parameter_172ef471 == nullptr) || (_parameter_172ef471Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Initialize(_parameter_172ef471);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_172ef471Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_172ef471Proxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_3fcb95e4InstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_3fcb95e4{};
                ProxyStub::UnknownProxy* _parameter_3fcb95e4Proxy__ = nullptr;
                if (_parameter_3fcb95e4InstanceId__ != 0) {
                    _parameter_3fcb95e4Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_3fcb95e4InstanceId__, false, _parameter_3fcb95e4);
                    ASSERT((_parameter_3fcb95e4 != nullptr) && (_parameter_3fcb95e4Proxy__ != nullptr));
                    if ((_parameter_3fcb95e4 == nullptr) || (_parameter_3fcb95e4Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                implementation->Deinitialize(_parameter_3fcb95e4);

                if (_parameter_3fcb95e4Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_3fcb95e4Proxy__, message->Response());
                }
    ...
    static ProxyStub::MethodHandler ExchangeWebPAWebPAClientStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_ef007f7eInstanceId__ = reader.Number<Core::instance_id>();

                PluginHost::IShell* _parameter_ef007f7e{};
                ProxyStub::UnknownProxy* _parameter_ef007f7eProxy__ = nullptr;
                if (_parameter_ef007f7eInstanceId__ != 0) {
                    _parameter_ef007f7eProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_ef007f7eInstanceId__, false, _parameter_ef007f7e);
                    ASSERT((_parameter_ef007f7e != nullptr) && (_parameter_ef007f7eProxy__ != nullptr));
                    if ((_parameter_ef007f7e == nullptr) || (_parameter_ef007f7eProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Configure(_parameter_ef007f7e);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_ef007f7eProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_ef007f7eProxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Initialize(PluginHost::IShell* _parameter_172ef471) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_172ef471));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_172ef471), PluginHost::IShell::ID }, { 0, 0 } };
        ...
        void Deinitialize(PluginHost::IShell* _parameter_3fcb95e4) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_3fcb95e4));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_3fcb95e4), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
    ...
    public:
        ...
        uint32_t Configure(PluginHost::IShell* _parameter_ef007f7e) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_ef007f7e));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_ef007f7e), PluginHost::IShell::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
