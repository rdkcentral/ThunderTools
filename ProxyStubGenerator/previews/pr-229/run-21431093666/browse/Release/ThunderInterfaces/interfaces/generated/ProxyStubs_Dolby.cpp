...
namespace ProxyStubs {
    ...
    static ProxyStub::MethodHandler ExchangeDolbyOutputStubMethods[] = {
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                Core::instance_id _parameter_7005a71bInstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_7005a71b{};
                ProxyStub::UnknownProxy* _parameter_7005a71bProxy__ = nullptr;
                if (_parameter_7005a71bInstanceId__ != 0) {
                    _parameter_7005a71bProxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_7005a71bInstanceId__, false, _parameter_7005a71b);
                    ASSERT((_parameter_7005a71b != nullptr) && (_parameter_7005a71bProxy__ != nullptr));
                    if ((_parameter_7005a71b == nullptr) || (_parameter_7005a71bProxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Register(_parameter_7005a71b);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_7005a71bProxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_7005a71bProxy__, message->Response());
                }
        ...
        [](Core::ProxyType<Core::IPCChannel>& channel, Core::ProxyType<RPC::InvokeMessage>& message) {
            ...
            hresult = [&]() -> Core::hresult {
                ...
                RPC::Data::Frame::Reader reader(message->Parameters().Reader());
                if (reader.Length() < (sizeof(Core::instance_id))) { return (COM_ERROR | Core::ERROR_READ_ERROR); }
                Core::instance_id _parameter_31c91909InstanceId__ = reader.Number<Core::instance_id>();

                Exchange::Dolby::IOutput::INotification* _parameter_31c91909{};
                ProxyStub::UnknownProxy* _parameter_31c91909Proxy__ = nullptr;
                if (_parameter_31c91909InstanceId__ != 0) {
                    _parameter_31c91909Proxy__ = RPC::Administrator::Instance().ProxyInstance(channel, _parameter_31c91909InstanceId__, false, _parameter_31c91909);
                    ASSERT((_parameter_31c91909 != nullptr) && (_parameter_31c91909Proxy__ != nullptr));
                    if ((_parameter_31c91909 == nullptr) || (_parameter_31c91909Proxy__ == nullptr)) { return (COM_ERROR | Core::ERROR_NOT_EXIST); }
                }

                uint32_t result = implementation->Unregister(_parameter_31c91909);

                RPC::Data::Frame::Writer writer(message->Response().Writer());
                writer.Number<uint32_t>(result);

                if (_parameter_31c91909Proxy__ != nullptr) {
                    RPC::Administrator::Instance().Release(_parameter_31c91909Proxy__, message->Response());
                }
    ...
    public:
        ...
        uint32_t Register(Exchange::Dolby::IOutput::INotification* _parameter_7005a71b) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(0));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_7005a71b));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_7005a71b), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
        ...
        uint32_t Unregister(Exchange::Dolby::IOutput::INotification* _parameter_31c91909) override
        {
            IPCMessage message(static_cast<const ProxyStub::UnknownProxy&>(*this).Message(1));

            RPC::Data::Frame::Writer writer(message->Parameters().Writer());
            writer.Number<Core::instance_id>(RPC::instance_cast(_parameter_31c91909));

            const RPC::InstanceRecord passedInstances[] = { { RPC::instance_cast(_parameter_31c91909), Exchange::Dolby::IOutput::INotification::ID }, { 0, 0 } };
            static_cast<const ProxyStub::UnknownProxy&>(*this).Channel()->CustomData(passedInstances);
