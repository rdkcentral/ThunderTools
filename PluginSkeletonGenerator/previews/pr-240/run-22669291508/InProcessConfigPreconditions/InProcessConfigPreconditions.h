...
namespace Plugin {
    ...
    public:
        ...
        Core::hresult Register(Exchange::IDictionary::INotification* const /* sink */) override;

        Core::hresult Unregister(const Exchange::IDictionary::INotification* const /* sink */) override;
