...
namespace Exchange {
    ...
    struct EXTERNAL IWifiControlTwo : virtual public Core::IUnknown {
        ...
        // @event
        struct EXTERNAL INotificationThree : virtual public Core::IUnknown {
        ...
        // @json
        struct EXTERNAL INotificationFour : virtual public Core::IUnknown {
            enum { ID = ID_WIFICONTROL_NOTIFICATION };
            ~INotificationTwo() override = default;
